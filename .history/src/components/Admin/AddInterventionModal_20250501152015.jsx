...
const AddInterventionModal = ({ isOpen, onClose }) => {
  ...
  const confirmSubmit = async () => {
    ...
    try {
      // Here you would typically call your API to submit the intervention
  ...
  return (
    <>
      ...
      >
        <div className="modal-box bg-white rounded-3xl shadow-2xl w-9/12 max-w-5xl p-12 relative">
          <button
      ...
      {/* StreetView Modal (optional) */}
      {/* You can add any additional modals here if needed */}
    </>
  );
};
