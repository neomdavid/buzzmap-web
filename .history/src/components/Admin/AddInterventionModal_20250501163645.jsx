                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="select rounded-lg bg-base-200 w-full border-0 text-lg"
                          required
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className="input border-0 w-full rounded-lg bg-base-200 text-lg"
                  ...
                  <div className="form-control">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="select border-0 rounded-lg w-full bg-base-200 text-lg"
                      required
                    >
                  ...
                  <div className="form-control">
                    ...
                    <inp
                      ...
                      value={formData.date}
                      onChange={handleChange}
                      className="input border-0 py-3 w-full rounded-lg bg-base-200 text-lg"
                      required
                    />
                  </div>
