...
import { useCreateInterventionMutation } from "../../api/dengueApi"; // Import the createIntervention API hook
import geojsonData from "../../path-to-geojson/quezon_barangays_boundaries.geojson"; // Make sure to adjust the path
...
const AddInterventionModal = ({ isOpen, onClose }) => {
  ...
  // Initialize the barangay options from GeoJSON
  useEffect(() => {
    const barangays = geojsonData.features.map(
  ...
  const confirmSubmit = async () => {
    ...
    try {
      // Make the API call to create an intervention
