...
export default function DengueChartCard() {
  return (
    <div className="w-full bg-primary max-w-4xl mx-auto p-6 rounded-sm">
      <p className="text-xl text-center font-semibold mb-4 text-white">
        Monthly Dengue Cases (2024)
      </p>
      <ResponsiveContainer width="100%" height={200}>
        <LineChart data={data} margin={{ left: -32, bottom: 10 }}>
