      ...
      <div className="flex flex-col gap-4 p-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative">
              <span className="absolute left-3 top-2.5 text-gray-500">OR</span>
              <input
                type="email"
                value={partnerEmail}
        ...
        <div className="w-full flex justify-center mt-4">
          <button
            type="submit"
            className="bg-primary hover:bg-primary-dark transition-colors rounded-full font-semibold text-white py-2 px-8 text-lg shadow-md hover:cursor-pointer"
          >
            Send Request
          </button>
        </div>
