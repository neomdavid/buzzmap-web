    ...
    >
      <div className="modal-box bg-white rounded-4xl shadow-2xl w-11/12 max-w-3xl p-12 relative">
        ...
        <div className="modal-action flex justify-center gap-6">
          <button
            className="bg-primary text-white font-semibold py-2 px-12 rounded-xl hover:bg-primary/80 transition-all hover:cursor-pointer"
            onClick={() => onClose()}
          >
            Edit
          </button>
          <button
            className="bg-error text-white font-semibold py-2 px-12 rounded-xl hover:bg-error/80 transition-all hover:cursor-pointer"
            onClick={() => {
