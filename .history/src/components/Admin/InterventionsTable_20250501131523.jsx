...
function InterventionsTable({ posts, onlyRecent = false }) {
  ...
  const addNewIntervention = () => {
    const newIntervention = {
      id: posts.length + 1,
      barangay: "Barangay X", // Placeholder data, you can customize this
      date: new Date().toISOString(),
      interventionType: "New Intervention", // Placeholder data
      personnel: "New Personnel", // Placeholder data
      status: "Scheduled", // Default status
    };
    // Add the new intervention to the posts array
    posts.push(newIntervention);
    ...
    <>
      <div>
        <button
          ...
          onClick={addNewIntervention} // Handle adding a new intervention
        >
