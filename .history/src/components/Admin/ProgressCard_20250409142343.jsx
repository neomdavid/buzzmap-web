    ...
    <div className="flex flex-col gap-1.5 bg-white p-5 rounded-3xl shadow-sm">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex justify-end">
          <button
            className="z-1000 text-xs bg-base-content text-white font-light px-4 py-2 rounded-full transition-all duration-200 hover:brightness-110 active:scale-95"
            onClick={onEdit}
          >
