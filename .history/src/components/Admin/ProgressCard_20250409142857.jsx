...
const ProgressCard = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 bg-white p-5 pl-6 rounded-3xl shadow-sm">
      {/* Header */}
      ...
      {/* Progress Bar */}
      <div className="w-full bg-gray-200 h-2.5 rounded-full my-2">
        <div
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex justify-end">
          <button
            className="text-sm bg-base-content text-white font-light px-4 py-2 rounded-full transition-all duration-200 hover:brightness-110 active:scale-95"
            onClick={onEdit}
          >
