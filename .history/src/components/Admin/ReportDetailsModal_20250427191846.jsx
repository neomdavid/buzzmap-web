...
const ReportDetailsModal = ({
  ...
  onClose,
  coordinates,
  actionType, // New prop to determine whether it's verify or reject
  ...
  const handleConfirmAction = () => {
    onConfirmAction(actionType); // Pass the action type to handle the verification/rejection
    ...
    >
      <div className="modal-box bg-white rounded-lg shadow-2xl max-w-4xl p-8 relative">
        ...
        <div className="space-y-6">
          {/* Report Details - Minimal for verify/reject */}
          {actionType === "view" ? (
