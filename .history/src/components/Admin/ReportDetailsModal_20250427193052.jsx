      ...
      <div className="modal-box bg-white rounded-3xl shadow-2xl max-w-4xl p-12 relative">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 text-lg p-4 rounded-lg">
            ...
            <p>
              <span className="font-semibold text-primary">Barangay:</span>{" "}
              {barangay}
            </p>
            <p>
              <span className="font-semibold text-primary">Coordinates:</span>{" "}
            ...
            <p>
              <span className="font-semibold text-primary">Date and Time:</span>{" "}
