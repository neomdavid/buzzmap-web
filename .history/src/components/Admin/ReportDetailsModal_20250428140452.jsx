...
const ReportDetailsModal = ({
  ...
  }, [isLoaded, coordinates, images, showStreetView]);
    ...
    >
      <div className="modal-box bg-white rounded-3xl shadow-2xl w-9/12 max-w-4xl p-12 relative">
        ...
        <div className="space-y-6">
          ...
          {/* Show Street View if no images OR user clicked the button */}
          {type === "view" &&
            coordinates?.length === 2 &&
            (showStreetView || !images?.length) && (
