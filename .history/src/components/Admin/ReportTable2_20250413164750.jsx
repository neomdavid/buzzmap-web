...
function ReportTable2() {
  ...
  const handleGridReady = (params: GridReadyEvent) => {
    ...
    handleGridResize(params);
  };

  const handleGridResize = (params: GridSizeChangedEvent) => {
    const width = params.api.getGridBodyClientRect().width;

    // Example: hide "id" column if grid width is less than 640px
    const shouldHideId = width < 640;
    params.columnApi.setColumnVisible("id", !shouldHideId);
