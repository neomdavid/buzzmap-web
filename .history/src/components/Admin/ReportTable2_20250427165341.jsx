...
function ReportTable2({ posts, isActionable = true }) {
  ...
  const columnDefs = useMemo(() => {
    const baseCols = [
      ...
      { field: "barangay", headerName: "Barangay", minWidth: 150 }, // Separate column for barangay
      {
        field: "coordinates",
        headerName: "Coordinates",
        minWidth: 200, // Separate column for coordinates
        cellRenderer: (params) => {
          // Render the coordinates as a string (latitude, longitude)
