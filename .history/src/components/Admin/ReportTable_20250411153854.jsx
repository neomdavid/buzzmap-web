...
const ReportTable = ({ rows, hasActions = false }) => {
  ...
  const actionColumn = columnHelper.display({
    ...
    header: "Actions",
    cell: () => (
      <div className="flex gap-4 text-primary text-[12px] border-l-[1.6px] border-gray-300 pl-2 ml-[-4px]">
        <button className="flex items-center gap-1 p-1 rounded-md hover:bg-gray-500 hover:cursor-pointer ">
