  ...
  const actionColumn = columnHelper.display({
    ...
    cell: ({ row }) => {
      ...
      return (
        ...
        >
          <button className="flex flex-1 justify-center items-center gap-1 p-1 rounded-md hover:bg-gray-100 hover:cursor-pointer">
          ...
          {!isVerified && (
            <>
              <button className="flex flex-1 items-center text-success gap-1 p-1 rounded-md hover:bg-gray-100 hover:cursor-pointer">
                <div className="rounded-full bg-success p-0.5">
                  <IconCheck size={12} color="white" stroke={4} />
                </div>
                <p>verify</p>
              </button>
              <button className="flex flex-1 items-center text-error gap-1 p-1 rounded-md hover:bg-gray-100 hover:cursor-pointer">
