...
const VerifyReportModal = ({
  ...
  <div className="grid grid-cols-2 gap-6 p-4 rounded-lg">
    {/* Left Column */}
    ...
    <div className="space-y-2 text-lg">
      <p className="font-semibold">
        <span className="text-gray-500 font-normal mr-1">Description:</span>
        {description}
      </p>
      <p className="font-semibold">
        <span className="text-gray-500 font-normal mr-1">Date and Time:</span>
