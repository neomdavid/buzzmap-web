          ...
          <div className="text-center space-y-4">
            <div className="flex justify-center gap-4">
              <button
                ...
                className={`bg-success text-white font-semibold  px-7 py-2 rounded-2xl hover:cursor-pointer hover:opacity-70 transition-all duration-200`}
              >
                Verify
              </button>
              <button className="bg-error text-white font-semibold  px-7  py-2 rounded-2xl hover:cursor-pointer hover:opacity-70 transition-all duration-200">
                Reject
              </button>
            </div>
          </div>
