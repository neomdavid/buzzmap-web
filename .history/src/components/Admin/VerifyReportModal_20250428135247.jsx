  ...
  return (
    ...
    >
      <div className="modal-box bg-white rounded-3xl shadow-2xl w-9/12  max-w-4xl p-12 relative">
        <button
          className="absolute top-30 right-10 text-2xl font-semibold hover:text-gray-500"
          onClick={onClose}
        >
          ✕
        </button>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="flex justify-center gap-4">
              ...
              <button className="bg-error text-white font-semibold  px-7  py-2 rounded-xl hover:cursor-pointer hover:opacity-70 transition-all duration-200">
                Reject
              </button>
            </div>
          </div>
