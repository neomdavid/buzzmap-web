  ...
  return (
    <section className="bg-primary text-white flex flex-col p-4 py-6 rounded-2xl ">
      ...
      <div>
        ...
        <br />
        <p>
          Quezon City is currently facing a <b>dengue outbreak</b>, with cases
          surging by 200% from January 1 to February 14. Residents are urged to
          take immediate precautions to prevent the spread of the disease.
        </p>
      </div>
