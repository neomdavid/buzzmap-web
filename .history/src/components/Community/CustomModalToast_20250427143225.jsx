...
const CustomModalToast = ({ message, type, onClose }) => {
  ...
  return (
    <div style={toastStyle}>
      ...
      <button
        onClick={onClose}
        className="ml-3 text-white border-none bg-transparent focus:outline-none hover:cursor-pointer hover:bg-gray-300 p-4  h-6 w-6 flex justify-center items-center rounded-full"
      >
        ✕
      </button>
    </div>
