                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            type="text"
                            className="input input-bordered p-6 p-6 w-full text-lg"
                            value="Quezon City"
                            readOnly
                          />
                        </div>
                        ...
                        <div>
                          <label className="label">
                            <span className="label-text mb-2">Barangay</span>
                          </label>
                          <input
                            type="text"
                            className="input input-bordered p-6 p-6 w-full text-lg"
                      ...
                      <div>
                        <label className="label">
                          <span className="label-text mb-2">Coordinates</span>
                        </label>
                        <input
                          type="text"
                          className="input input-bordered p-6 w-full text-lg"
                          value={coordinates}
                          readOnly
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <input
                            type="text"
                            className="input input-bordered p-6 flex-1 text-lg"
