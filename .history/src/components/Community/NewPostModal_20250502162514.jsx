...
const NewPostModal = ({ onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log("🔐 Current token:", token); // Assuming token is available in scope
    ...
    try {
      ...
      // Call createIntervention mutation with FormData
      const response = await createIntervention(formData).unwrap();

      console.log("✅ Intervention uploaded successfully", response);
