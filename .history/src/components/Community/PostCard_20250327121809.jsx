  ...
  return (
    <section className="bg-base-200 px-8 py-6 rounded-lg">
      <div className="shadow-sm bg-white rounded-lg px-6 pt-6 pb-4">
        ...
        {/* Image Grid */}
        {images.length > 0 && (
          <div className="grid grid-cols-2 gap-2 xl:gap-[-10px] mt-4">
            {images.slice(0, 4).map((img, index) => (
              <div key={index} className="relative max-w-[300px] max-h-[225px]">
                ...
                {index === 3 && images.length > 4 && (
                  <div className="absolute inset-0 w-full h-full  bg-opacity-20 flex items-center justify-center rounded-lg">
