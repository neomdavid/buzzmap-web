...
import { useGoogleMaps } from "../GoogleMapsProvider"; // Assuming the context is correctly set up for Google Maps
...
const PostCard = ({
  ...
  useEffect(() => {
    if (coordinates && coordinates.length === 2 && isLoaded) {
      // Geocode the coordinates when the component mounts and Google Maps is loaded
      geocodeCoordinates(coordinates[0], coordinates[1]);
    }
  }, [coordinates, isLoaded]); // Dependencies include coordinates and isLoaded status
