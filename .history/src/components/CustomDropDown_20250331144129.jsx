...
import { ChevronDownIcon } from "@heroicons/react/24/solid"; // Using Heroicons for dropdown icon
  ...
  return (
    <div className="w-full max-w-sm relative text-white">
      <div className="relative">
        ...
        <ChevronDownIcon className="absolute right-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-white pointer-events-none" />
      </div>
