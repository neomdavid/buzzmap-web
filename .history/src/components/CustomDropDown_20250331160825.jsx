...
const CustomDropDown = ({
  ...
  return (
    <div className={`w-full max-w-sm relative  z-1000000 ${className}`}>
      <div className="relative">
        <input
          type="text"
          className={`w-full p-4 pr-12 border-[1.5px] border-white rounded-full ${
            fillColor == "bg-white" ? "bg-white text-primary" : "bg-transparent"
          } text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-blue-400`}
