  ...
  return (
    ...
    >
      <div className="relative">
        <input
          type="text"
          className={`w-full p-4 pr-12 border-[1.5px] border-white rounded-full text-white placeholder-white focus:outline-none focus:ring-2 focus:ring-blue-400 ${
            fillColor == "bg-white"
              ? "bg-transparent text-primary placeholder-primary text-primary"
              : "bg-transparent"
          } `}
