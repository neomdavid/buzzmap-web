  ...
  return fillColor === "dark" ? (
    ...
    >
      <div className="relative">
        <input
          type="text"
          className="w-full p-4 pr-12 border-[1.5px] border-white rounded-full bg-white text-primary placeholder-primary text-md focus:outline-none focus:ring-2 focus:ring-blue-400"
          placeholder="Select Location"
          value={inputValue}
          onChange={handleInputChange}
          onFocus={() => setShowDropdown(true)}
