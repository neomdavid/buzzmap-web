  ...
  return fillColor === "dark" ? (
    ...
    >
      <div className="relative">
        <input
          type="text"
          className="w-full p-3.5 pr-12 border-[1.5px] border-white rounded-2xl bg-white text-primary placeholder-primary text-[12px] focus:outline-none focus:ring-2 focus:ring-blue-400"
          placeholder="Select Location"
          value={inputValue}
          onChange={handleInputChange}
          onFocus={() => setShowDropdown(true)}
        />
        <IconChevronDown className="absolute right-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-primary pointer-events-none hover:cursor-pointer z-100000000" />
      </div>
