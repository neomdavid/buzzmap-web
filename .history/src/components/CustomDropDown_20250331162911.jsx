  ...
  return fillColor === "dark" ? (
    ...
    >
      <div className="relative">
        <input
          type="text"
          className="w-full p-3.5 pr-12 border-[1.5px] border-white rounded-2xl bg-white text-primary placeholder-primary text-[12px] focus:outline-none focus:ring-2 focus:ring-accent"
          placeholder="Select Location"
          value={inputValue}
          onChange={handleInputChange}
          onFocus={() => setShowDropdown(true)}
