...
const CustomFormInput = ({
  ...
  return (
    ...
    ${isFocused ? "outline outline-2" : ""}
    ${
      isFocused
        ? "outline-primary dark:outline-white"
        : "border-gray-300 dark:border-gray-600"
    }
    focus-within:outline focus-within:outline-2 focus-within:outline-primary dark:focus-within:outline-white`}
      >
        <input
