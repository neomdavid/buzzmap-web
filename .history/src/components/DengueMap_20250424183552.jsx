...
const DengueMap = () => {
  ...
  useEffect(() => {
    ...
    // If you want to avoid checking user's location or showing notifications
  ...
  const handleLocationSelect = (coords) => {
    if (
      ...
      return false; // Just return false without showing a notification
    }
  ...
  const removePin = () => setMarkerPosition(null);
