    ...
    <div className="w-full" style={{ height: height }}>
      <GoogleMap
        ...
        options={{
          ...
          tilt: 45, // Set tilt to simulate a 3D effect
          heading: 90, // Rotate the map to get a better 3D perspective
          disableDefaultUI: false, // Optionally disable default UI elements
        }}
      >
        <Polygon
