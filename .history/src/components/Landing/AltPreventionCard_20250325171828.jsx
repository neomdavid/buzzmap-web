...
const AltPreventionCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <p
        className={`absolute text-4xl leading-8 text-primary font-bold ${titlePosition}`}
      >
        {title}
      </p>
      ...
      {/* Subtext */}
      <p
        className={`absolute text-sm max-w-[140px] font-semibold text-primary opacity-80 ${subtextPosition}`}
      >
        {subtext}
      </p>
