...
const AltPreventionCard = ({
  ...
  return (
    <section
      className={`min-w-[200px] h-[290px] lg:min-w-[250px] lg:h-[340px] relative rounded-[37px]  flex ${bgColor}`}
    >
      ...
      {/* Title */}
      <p
        className={`absolute mx-2 text-4xl leading-8 text-primary font-bold  lg:text-[32px] lg:leading-12 ${titlePosition} text-${titleAlign}`}
      >
        {title}
      </p>
