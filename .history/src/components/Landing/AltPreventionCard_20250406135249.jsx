...
const AltPreventionCard = ({
  ...
  return (
    <section
      className={`min-w-[200px] h-[290px] lg:min-w-[250px] lg:h-[340px] relative rounded-[37px] xl:h-[400px] xl:min-w-[300px] 2xl:min-w-[350px] 2xl:min-h-[450px]  flex ${bgColor}`}
    >
      ...
      {/* Subtext */}
      <p
        className={`absolute text-sm max-w-[140px] font-normal text-primary opacity-80 xl:text-[12.5px] ${subtextPosition} text-${subtextAlign}`}
      >
        {subtext}
      </p>
