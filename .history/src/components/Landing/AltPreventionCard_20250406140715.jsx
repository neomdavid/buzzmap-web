    ...
    >
      ...
      {Icon && (
        <Icon
          size={iconSize}
          weight="fill"
          className={`absolute text-primary lg:w-50 lg:h-50 xl:w-60 xl:h-60 ${iconPosition}`}
      ...
      {/* Subtext */}
      <p
        className={`absolute text-sm max-w-[140px] font-normal text-primary opacity-80 xl:text-[12.5px] xl:max-w-[160px] ${subtextPosition} text-${subtextAlign}`}
      >
        {subtext}
      </p>
