...
const PreventionCard = () => {
  return (
    <section className="min-w-[200px] h-[290px] relative rounded-[37px]  overflow-hidden">
      {/* Background Image */}
      <div
      ...
      {/* Circle with Icon */}
      <div className="h-27 w-27 bg-white border-18 border-primary rounded-full absolute right-[-18px] bottom-[-12px] flex items-center justify-center">
