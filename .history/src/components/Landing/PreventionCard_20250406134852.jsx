...
const PreventionCard = ({ title, category, bgImg, to }) => {
  ...
  return (
    <section className=" relative min-w-[200px] h-[290px] lg:min-w-[250px] lg:h-[340px] xl:h-[400px] xl:min-w-[300px]">
      ...
      <p className="text-3xl lg:text-4xl text-white absolute bottom-9 left-5 leading-7.5 font-bold w-[100px] lg:w-[140px] lg:leading-8.5 xl:text-[40px] xl:leading-10.1">
        {title}
      </p>
