...
const PreventionCard = ({ title, category, bgImg, to }) => {
  ...
  return (
    <section className=" relative min-w-[200px] h-[290px] lg:min-w-[250px] lg:h-[340px] xl:h-[400px] xl:min-w-[300px]">
      ...
      <p className="text-xs font-normal p-2 px-4 rounded-full italic absolute bottom-41 lg:bottom-46 xl:bottom-587.5 xl:text-[11px]  left-5 leading-7.5 font-bold text-primary bg-white">
        {category}
      </p>
