...
const PreventionCard = ({ title, category, bgImg, to }) => {
  ...
  return (
    <section className=" relative min-w-[200px] h-[290px] lg:min-w-[250px] lg:h-[340px] xl:h-[400px] xl:min-w-[300px] 2xl:min-w-[320px] 2xl:min-h-[450px] ">
      ...
      <p className="text-md font-normal p-2 px-4 rounded-full italic absolute bottom-41 lg:bottom-46 xl:bottom-57.5 xl:text-[11px]  left-5 leading-7.5 font-bold text-primary bg-white">
        {category}
      </p>
