...
const LogoNamed = ({
  ...
  return theme === "light" ? (
    ...
    >
      <LightBgLogo className={`${iconSize} xl:h-13 w-13 mt-[-1px]`} />
      <div
        className={`${textSize} flex italic font-extrabold tracking-wider font-title uppercase text-2xl xl:text-4xl`}
      >
    ...
    >
      ...
      <div
        className={`text-[24px] flex italic font-extrabold tracking-wider font-title uppercase text-2xl xl:text-4xl`}
      >
