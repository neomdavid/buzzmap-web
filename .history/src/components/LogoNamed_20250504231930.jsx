...
const LogoNamed = ({
  ...
  return theme === "light" ? (
    ...
    >
      ...
      >
        <h1 className="text-primary text-[12px]">buzz</h1>
        <h1 className="text-accent-content text-[12px]">map</h1>
      </Link>
    </div>
  ) : (
    <div
    ...
    >
      ...
      >
        <h1 className="text-white text-[12px]">buzz</h1>
        <h1 className="text-white text-[12px]">map</h1>
      </div>
    </div>
  );
};
