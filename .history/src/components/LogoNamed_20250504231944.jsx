...
const LogoNamed = ({
  ...
  return theme === "light" ? (
    ...
    >
      ...
      >
        <h1 className="text-primary text-[40px]">buzz</h1>
        <h1 className="text-accent-content text-[40px]">map</h1>
      </Link>
    </div>
  ) : (
    <div
    ...
    >
      ...
      >
        <h1 className="text-white text-[40px]">buzz</h1>
        <h1 className="text-white text-[40px]">map</h1>
      </div>
    </div>
  );
};
