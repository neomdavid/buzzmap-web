    ...
    <>
      <GoogleMap
        ...
        onLoad={(map) => {
          ...
          // Disable the click event on the polygon using pointerEvents
          const polygon = new window.google.maps.Polygon({
            paths: qcPolygonPaths,
          });
          polygon.setMap(map);
          polygon.setOptions({
            clickable: false, // Disable click events on the polygon
          });
        }}
      ...
      >
        <Polygon
          ...
          options={{
            ...
            fillColor: "#FF0000", // Fill color (still set, but will not be visible)
            fillOpacity: 0, // Set opacity to 0 to hide the fill color
          }}
        />
        {markerPosition && (
          <Marker
