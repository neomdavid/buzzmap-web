      ...
      >
        ...
        {markerPosition && (
          <Marker
            ...
            icon={{
              url: "https://maps.gstatic.com/mapfiles/ms2/micons/red-pushpin.png", // Red pushpin icon
              scaledSize: new window.google.maps.Size(50, 80), // Scale the pin to be larger
              anchor: new window.google.maps.Point(25, 80), // Anchor the pin at the bottom
            }}
          />
        )}
      </GoogleMap>
