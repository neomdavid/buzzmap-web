  ...
  useEffect(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      ({ coords }) => {
        ...
        // ✅ Only set the marker if within QC bounds
        if (
          ...
          setMarkerPosition(p);
          // Optional: you can preselect the barangay silently here if needed
          // handleSelection(p); ❌ Don't call this yet unless you're sure it's user intent
        } else {
          // If user's current location is outside QC, just show fallback
