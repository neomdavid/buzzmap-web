...
const Navbar = () => {
  ...
  // Check if the current route matches "/mapping/{at least one character}"
  const isMappingRoute =
    currentRoute === "/mapping" || /^\/mapping\/.+/.test(currentRoute);

  return isMappingRoute ? (
