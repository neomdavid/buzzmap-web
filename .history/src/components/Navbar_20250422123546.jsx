  ...
  const renderProfile = (darkMode = false) => (
    <>
      <div className="dropdown dropdown-end">
        ...
        <ul
          tabindex="0"
          className="dropdown-content menu bg-primary text-white rounded-xl z-1 w-120 p-8 py-10 shadow-sm flex flex-col justify-center"
        >
          <p className="text-center font-bold text-2xl">{user.name}</p>
          <p className="text-center font-light text-lg">{user.email}</p>
        </ul>
      </div>
    </>
  );
