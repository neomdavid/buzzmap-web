    ...
    <>
      <div className="dropdown dropdown-end">
        <div
          tabindex="0"
          role="button"
          class="flex border-1 border-gray-300 rounded-full p-3 gap-1 items-center hover:cursor-pointer border-transparent hover:border-3 hover:border-gray-400 transition-all duration-200  "
        >
          <span
        ...
        >
          ...
          <button className="w-full text-center hover:bg-gray-600 p-4 text-lg hover:cursor-pointer">
            Logout
          </button>
        </ul>
      </div>
