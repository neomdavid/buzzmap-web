    ...
    <>
      <div className="dropdown dropdown-end">
        <div
          tabindex="0"
          role="button"
          class="flex border-1 border-gray-300 rounded-full p-3 gap-1 items-center hover:cursor-pointer hover:border-2 hover:border-gray-200 transition-all duration-200  "
        >
          <span
        ...
        <ul
          tabindex="0"
          className="dropdown-content menu bg-primary text-white rounded-xl z-1 w-120  shadow-sm flex flex-col justify-center "
        >
          <div className="p-6 flex flex-col gap-1">
            <div className="w-full flex justify-center mb-3">
              <IconUserCircle size={60} className="text-white " />
            </div>
          ...
          <button className="w-full text-center hover:bg-error p-4 text-lg hover:cursor-pointer transition-all duration-300 rounded-2xl">
            Logout
          </button>
        </ul>
      </div>
