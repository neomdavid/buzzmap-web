...
const Navbar = () => {
  ...
  const renderLoginButton = () => (
    <button
      ...
      className={`text-primary font-semibold py-2 px-4 rounded-lg border border-primary hover:bg-primary hover:text-white transition-all duration-300 text-lg ${isDark?'border-white':}`}// Added text-lg
    >
      Login
    </button>
  );
