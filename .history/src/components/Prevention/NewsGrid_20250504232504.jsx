  ...
  return (
    <div className="flex flex-col gap-10 xl:grid xl:grid-cols-6 xl:items-start">
      ...
      <div className="grid sm:grid-cols-12 xl:col-span-4 gap-10 h-full">
        ...
        <div
          className="h-110 p-5 sm:h-full sm:col-span-8 rounded-xl overflow-hidden flex flex-col justify-end p-6 px-8 relative cursor-pointer hover:shadow-lg transition-shadow duration-300"
          style={{
