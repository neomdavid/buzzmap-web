...
const NewsGrid = ({ articles }) => {
  ...
  return (
    <div className="flex flex-col gap-10 xl:grid xl:grid-cols-6 xl:items-start">
      ...
      <div className="flex gap-7 xl:col-span-2 xl:flex-col">
        {articles.slice(2, 4).map((article, index) => (
          <div
            key={article.id}
            className="w-full p-5 sm:col-span-6 gap-3 flex flex-col rounded-xl overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300"
