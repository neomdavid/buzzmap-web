...
const SecondaryButton = ({ text, to, maxWidth, icon }) => {
  return (
    <div
      ...
      className="flex p-2 justify-between text-primary  shadow-lg rounded-xl font-semibold hover:cursor-pointer hover:scale-105 transition-scale duration-300 active:opacity-70"
    >
      <Link
