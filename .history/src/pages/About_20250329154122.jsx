      ...
      <article className="relative bg-primary w-[70vw] ml-auto h-[100vh]">
        ...
        <section className="text-white p-12">
          <div className="text-center">
            ...
            <p className="max-w-[80%] mx-auto mb-10 font-light">
              <b>BuzzMap</b> is proud to partner with the Quezon City
              Epidemiology & Surveillance Division, specifically Quezon City
              Environmental and Sanitation Unit <b>(QC CESU)</b> in the fight
              against dengue outbreaks. Together, we aim to empower the
              community with real-time data, alerts, and prevention tips,
