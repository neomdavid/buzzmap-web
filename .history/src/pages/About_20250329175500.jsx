...
const About = () => {
  return (
    <main>
      <article className="relative bg-primary w-[70vw] max-w-[1000px] ml-auto min-h-[95vh]">
        <img
          src={womanWithHand}
        ...
        <section className="grid grid-cols-4 justify-between w-[85%] ml-auto pl-5 pr-15">
          <MemberCard
            name="Zophia Rey"
