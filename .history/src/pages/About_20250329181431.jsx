...
const About = () => {
  return (
    <main>
      <article className="relative bg-primary w-[70vw] max-w-[1000px] ml-auto min-h-[93vh] overflow-y-hidden">
        <img
          src={womanWithHand}
        ...
        <section className="w-[90%] flex relative  justify-between mx-auto ">
          ...
          <img src={logoDarkBg} className=" absolute right-0 w-60 rotate-45 " />
        </section>
      </article>
    </main>
  );
