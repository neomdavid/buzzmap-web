...
const About = () => {
  return (
    <main>
      <article className="relative bg-primary w-[70vw] max-w-[1000px] ml-auto min-h-[93vh] overflow-y-clip">
        <img
          src={womanWithHand}
        ...
        <section className="w-[90%] flex relative  h-35 justify-between mx-auto ">
          <h1 className="text-left -translate-y-15  text-[20vw] text-white  tracking-wide">
            Meet <br /> the
            <br /> team
          </h1>
          <img
            src={logoDarkBg}
            className="absolute right-0 translate-x-30 -translate-y-20 max-w-[200px] rotate-45 "
          />
        </section>
      </article>
    </main>
