  ...
  return (
    <main>
      <article className="relative bg-primary w-[70vw] max-w-[1000px] ml-auto min-h-[93vh] overflow-y-clip">
        ...
        <section className="w-full flex relative h-35 justify-between ml-10 bg-red-100 overflow-hidden">
          <h1 className="text-left -translate-y-15 text-6xl text-white tracking-wide">
            Meet <br /> the <br /> team
          </h1>

          {/* Wrapper that clips the overflowing content */}
          <div
          ...
          >
            <img
              src={logoDarkBg}
              className="absolute right-0 translate-x-10 -translate-y-20 max-w-[200px] rotate-45"
            />
          </div>
        </section>
      </article>
