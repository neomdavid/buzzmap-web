...
const About = () => {
  return (
    <main className="overflow-clip">
      <article className="relative bg-primary w-[100vw] sm:md-[70vw] max-w-[1000px] ml-auto min-h-[93vh] overflow-y-clip">
        <img
          src={womanWithHand}
          className="w-140 absolute left-[-197px] hidden md:absolute"
