  ...
  return (
    <main className="overflow-clip">
      <article className="relative bg-primary w-[100vw] md:w-[70vw] max-w-[1000px] ml-auto min-h-[93vh] overflow-y-clip">
        ...
        <section className="text-white flex flex-col justify-center p-12 font-light mb-8">
        ...
        <section className="grid grid-cols-1 gap-y-12 sm:grid-cols-4 justify-between sm:w-[80%]  ml-auto pl-5 pr-15 mb-10">
          <MemberCard
            name="Zophia Rey"
