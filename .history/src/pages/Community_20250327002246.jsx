        ...
        <section className="bg-base-200 px-8 py-6 rounded-lg">
          <div className=" shadow-sm bg-white rounded-lg px-6 py-6 ">
            ...
            <div className="text-primary">
              ...
              <p>
                <span className="font-bold">🕑 Date & Time:</span> Barangay
                Bagumbayan, Taguig City
              </p>
              <p>
                <span className="font-bold">⚠️ Report Type:</span> Barangay
                Bagumbayan, Taguig City
              </p>
              <p>
                <span className="font-bold">📝 Description:</span> Barangay
                Bagumbayan, Taguig City
              </p>
            </div>
            <div></div>
