        ...
        <section className="bg-base-200 px-8 py-6 rounded-lg">
          <div className=" shadow-sm bg-white rounded-lg px-6 py-6 ">
            ...
            <div className="text-primary">
              ...
              <p>
                <span className="font-bold">📝 Description:</span> Discovered
                stagnant water in uncovered water containers behind a
                residential area. Mosquito larvae were visible. Urgent clean-up
                needed to prevent mosquito breeding.
              </p>
            </div>
            <div></div>
          </div>
