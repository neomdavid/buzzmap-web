...
import { DotsThree, Heart, Image } from "phosphor-react";
  ...
  return (
    <main className="pl-6 flex gap-x-6">
      <article className="flex-8 ">
        ...
        <section className="bg-base-200 px-8 pt-6 pb-4 rounded-lg">
          <div className=" shadow-sm bg-white rounded-lg px-6 py-6 ">
            ...
            <div className="flex justify-between">
              <div className="flex gap-x-1 hover:bg-gray-100 py-2 px-2 ">
