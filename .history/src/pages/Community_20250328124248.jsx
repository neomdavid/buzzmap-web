...
const Community = () => {
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative ">
      <article className="  shadow-xl p-12 rounded-lg w-[65vw]">
      ...
      <aside className=" z-[-2000] hidden overflow-scroll fixed top-30 bottom-0 right-0 left-[68vw] lg:block lg:flex-5 bg-base-300 px-6 py-8 shadow-md rounded-sm">
        <AnnouncementCard />
      </aside>
    </main>
  );
