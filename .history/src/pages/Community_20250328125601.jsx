...
const Community = () => {
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative ">
      <article className="  shadow-xl p-12 rounded-lg  w-[100vw] lg:w-[85vw]">
      ...
      <aside className="hidden lg:block  bg-base-300 px-6 py-8 shadow-md rounded-sm overflow-y-auto h-screen sticky top-0 left-0">
        <AnnouncementCard />
      </aside>
    </main>
  );
