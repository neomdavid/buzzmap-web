...
const Community = () => {
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative ">
      <article className="flex-8  shadow-xl p-12 rounded-lg w-[20px]">
      ...
      <aside className=" hidden absolute right-0 left-[20%] lg:block lg:flex-5 bg-base-300 px-6 py-8 shadow-md rounded-sm">
        <AnnouncementCard />
      </aside>
    </main>
  );
