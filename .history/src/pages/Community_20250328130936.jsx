    ...
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative">
      <article className="flex-8  shadow-xl p-12 rounded-lg">
        ...
        <Heading
          ...
          className="text-[47px] lg:text-8xl text-center mb-4 "
        />
      ...
      <aside className="hidden lg:block lg:flex-5 bg-base-300 px-6 py-8 shadow-md rounded-sm sticky top-29 h-screen overflow-scroll py-4">
        <AnnouncementCard />
      </aside>
    </main>
  );
