...
const Community = () => {
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative">
      <article className="flex-8  shadow-xl p-12 rounded-lg">
        <div className="relative w-full flex items-center">
          ...
          <MagnifyingGlass
            size={16}
            stroke={4}
            className="absolute left-7 top-7 -translate-y-1/2 text-primary rounded-lg"
          />

          {/* Input Field */}
          <input
            className="bg-base-200 p-6 pl-14 py-7 w-full h-12 mb-6 rounded-full focus:outline-primary/20"
            placeholder="Search..."
          />
        </div>
        ...
        <Heading
          ...
          className="text-[47px] lg:text-8xl leading-20 text-center mb-4 "
        />
      ...
      <aside className="hidden lg:block lg:flex-5 bg-base-300 px-6 py-8 shadow-md rounded-sm sticky top-28 h-screen overflow-scroll py-4">
        <AnnouncementCard />
      </aside>
    </main>
  );
