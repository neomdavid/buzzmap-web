    ...
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative">
      ...
      <aside
        className={`bg-base-300 px-6 py-8 shadow-md rounded-sm overflow-y-scroll transition-transform duration-500 ease-in-out 
          fixed inset-0 pt-20 lg:pt-6 z-50 lg:z-0 lg:static lg:inset-auto lg:translate-x-0 ${
      ...
      {!showAside && (
        <button
          ...
          className="sticky bottom-10 right-10 z-50 lg:hidden bg-primary text-white p-2 rounded-full"
        >
