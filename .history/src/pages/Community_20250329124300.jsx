...
const Community = () => {
  ...
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative">
      ...
      <aside
        className={`bg-base-300 px-6 py-8 shadow-md rounded-sm overflow-y-scroll transition-transform duration-300 ease-in-out 
    fixed inset-0 pt-20 lg:pt-6 z-50 lg:z-0 lg:sticky lg:top-22 lg:h-[calc(100vh-1.5rem)] lg:w-[35vw] lg:max-w-[450px]
    ${showAside ? "translate-x-[20vw]" : "translate-x-full"} lg:translate-x-0`}
      >
        <AnnouncementCard />
        {/* Close button for small screens */}
        <button
          onClick={() => setShowAside(false)}
          className="absolute top-4 right-4 lg:hidden bg-primary text-white p-2 rounded-full"
        >
