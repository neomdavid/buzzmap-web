...
const Community = () => {
  ...
  return (
    <main className="pl-6 flex gap-x-6 max-w-[1250px] m-auto relative">
      ...
      <aside
        className={`bg-base-300 px-6 py-8 shadow-3xl rounded-sm overflow-y-scroll transition-transform duration-300 ease-in-out 
    fixed inset-y-0 right-0 w-[70vw] max-w-[70vw] pt-20 lg:pt-6 z-50 lg:z-0 lg:sticky lg:top-22 lg:h-[calc(100vh-1.5rem)] 
