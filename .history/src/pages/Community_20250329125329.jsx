    ...
    lg:w-[35vw] lg:max-w-[450px] ${
      ...
      >
        ...
        <button
          ...
          className="absolute left-0 top-20 lg:hidden bg-primary text-white p-2 py-4 shadow-xl rounded-sm hover:cursor-pointer hover:bg-white hover:text-primary transition-all duration-200"
        >
