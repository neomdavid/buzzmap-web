...
const Landing = () => {
  return (
    <main className="flex flex-col">
      ...
      <div className="text-primary h-46 text-center font-semibold mb-6">
      ...
      <div className="w-[60%] m-auto mt-2 flex gap-x-2">
        <SecondaryButton />
        <SecondaryButton />
        <SecondaryButton />
      </div>
      ...
      <img
        src={patient1}
        className="h-auto object-cover rounded-xl mx-6 mt-[-55px] z-[-1]"
        style={{
          maskImage:
