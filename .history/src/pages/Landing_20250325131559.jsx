...
const Landing = () => {
  return (
    <main className="flex flex-col">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-6xl px-8 mb-6">
        <h1>
          Buzzing <span className="text-accent">with awareness</span>
        </h1>
        <h1 className="text-right mt-[-20px]">
      ...
      <h1 className="text-primary font-[Koulen] uppercase text-6xl ">
        Buzzing <span className="text-accent">with awareness</span>
      </h1>
    </main>
  );
