  ...
  return (
    <main className="flex flex-col">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-8 mb-6">
        ...
        <h1 className="text-right mt-[-5px]">
      ...
      <h1 className="text-primary font-[Koulen] uppercase text-7xl text-right mx-6">
        See the <span className="text-accent">danger zones</span>
      </h1>
