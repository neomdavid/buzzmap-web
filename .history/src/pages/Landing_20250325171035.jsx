      ...
      <article className="bg-primary mt-6 flex flex-col items-center py-10">
        ...
        <div className="flex gap-6">
          ...
          <AltPreventionCard
            ...
            category="Sanitation"
            Icon={Bug} // Phosphor Icon
            iconSize={120} // Adjust icon size
            iconPosition="top-4 left-4" // Move icon anywhere
            iconRotation={45} // Rotate icon
            titlePosition="bottom-16 left-5" // Move title anywhere
            subtextPosition="bottom-10 left-5" // Move subtext anywhere
            categoryPosition="bottom-5 left-5" // Move category anywhere
            bgColor="bg-primary" // Now supports Tailwind classes
            to="/sanitation"
          />
        </div>
      </article>
