      ...
      <article className="bg-primary mt-6 flex flex-col items-center py-10">
        ...
        <div className="flex gap-6">
          ...
          <AltPreventionCard
            ...
            titlePosition="top-30 left-8" // Move title anywhere
            subtextPosition="top-57 left-10" // Move subtext anywhere
            categoryPosition="top-20 left-8" // Move category anywhere
