  ...
  return (
    <main className="flex flex-col pb-100">
      ...
      <article
        ...
        className="bg-primary h-64 w-full flex justify-center items-center flex-col text-white"
      >
        <p className="text-6xl">Speak up, stay safe—</p>
        <span className="font-bold">let’s fight dengue together!</span>
      </article>
    </main>
  );
};
