...
const Landing = () => {
  return (
    <main className="flex flex-col pb-100">
      ...
      <article
        style={{
          clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 62%)",
        }}
        className="bg-primary h-64 w-full flex justify-center text-6xl items-center flex-col text-white"
      >
        <p className="">Speak up, stay </p>
        <p>
          safe—<span className="font-bold">let’s fight dengue together!</span>
        </p>
      </article>
    </main>
  );
