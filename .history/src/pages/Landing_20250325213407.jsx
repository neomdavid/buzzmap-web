...
const Landing = () => {
  return (
    <main className="flex flex-col pb-100">
      ...
      <article className="bg-primary mt-12 flex flex-col items-center py-16">
      ...
      <article
        ...
        className="bg-primary pt-26 pb-45 w-full flex justify-center text-7xl items-center flex-col text-white"
      >
