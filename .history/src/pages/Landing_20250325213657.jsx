  ...
  return (
    <main className="flex flex-col pb-100">
      ...
      <article
        ...
        className="bg-primary relative pt-22 pb-45 w-full flex justify-center text-7xl items-center flex-col text-white"
      >
        <Quotes className="absolute left-0 top-0" weight="fill" />
