  ...
  return (
    <main className="flex flex-col pb-100">
      ...
      <article
        ...
        className="bg-primary pt-22 pb-45 w-full flex justify-center text-7xl items-center flex-col text-white"
      >
        <p className=" relative">
          ...
          />
          <Quotes
            className="absolute right-[-190px] bottom-[-400px] rotate-183"
            weight="fill"
            size={82}
          />
        </p>
