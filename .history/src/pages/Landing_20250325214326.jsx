  ...
  return (
    <main className="flex flex-col pb-100">
      ...
      <article
        ...
        className="bg-primary pt-22 pb-50 w-full flex justify-center text-7xl items-center flex-col text-white"
      >
        <p className=" relative">
          ...
          />
          <Quotes
            className="absolute right-[-215px] bottom-[-275px] rotate-2"
            weight="fill"
            size={160}
          />
        </p>
