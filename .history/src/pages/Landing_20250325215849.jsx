...
const Landing = () => {
  return (
    <main className="flex flex-col pb-100">
      ...
      <footer className="flex text-primary justify-between px-6 mt-[-25px]">
        <div className="flex gap-x-6">
          <img src={logoFooter} className="w-[15%]" />
          <img src={logoSurveillance} className="w-[15%]" />
        </div>
        ...
        <div className="font-bold">copyright 2025<div>
      </footer>
    </main>
  );
};
