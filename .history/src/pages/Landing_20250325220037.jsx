...
const Landing = () => {
  return (
    <main className="flex flex-col pb-100">
      ...
      <footer className="flex text-primary justify-between px-6 mt-[-25px] w-full items-start">
        {/* Left Section */}
        <div className="flex gap-x-6 items-center">
          <img src={logoFooter} className="w-40 h-auto" />
          <img src={logoSurveillance} className="w-40 h-auto" />
        </div>
