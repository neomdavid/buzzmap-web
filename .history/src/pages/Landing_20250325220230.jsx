...
const Landing = () => {
  return (
    <main className="flex flex-col pb-100">
      ...
      <footer className="flex text-primary justify-between px-6 mt-[-25px] w-full items-start mr-6">
        {/* Left Section */}
        <div className="flex gap-x-16">
          <div className="flex gap-x-6 items-center">
            <img src={logoFooter} className="w-30 h-auto" />
            <img src={logoSurveillance} className="w-30  h-auto" />
          </div>

          {/* Center Section */}
          <div className="flex flex-col gap-y-6 text-sm mb-[-10px]">
