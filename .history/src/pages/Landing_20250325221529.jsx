  ...
  return (
    <main className="flex flex-col ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-8 mb-10">
        <Heading
          className="text-[47px] sm:text-7xl md:text-8xl md:leading-24 lg:text-9xl lg:leading-37 xl:text-[120px]"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] text-right sm:text-7xl md:text-8xl lg:text-9xl"
