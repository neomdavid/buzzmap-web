...
const Landing = () => {
  return (
    <main className="flex flex-col ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-8 mb-10 lg:max-w-[70vw] lg:self-center text-center">
        <Heading
          className="text-[47px] sm:text-7xl md:text-8xl md:leading-24 lg:self-start"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] text-right sm:text-7xl md:text-8xl lg:self-end"
