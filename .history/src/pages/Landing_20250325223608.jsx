...
const Landing = () => {
  return (
    <main className="flex flex-col ">
      ...
      <div className="flex flex-col gap-4 sm:flex-row w-[80%] m-auto mt-2  gap-x-3 justify-center">
        <SecondaryButton text={"Check Dengue Hotspots"} className="w-md sm:" />
        <SecondaryButton text={"Report a Dengue Case"} className="w-md sm:" />
        <SecondaryButton text={"Get Prevention Tips"} className="w-md sm:" />
      </div>
