...
const Landing = () => {
  return (
    <main className="flex flex-col ">
      ...
      <section className="flex flex-col lg:flex-row mx-4 justify-center">
        <div className="flex-8 h-auto bg-accent">hello</div>
        <div className="flex flex-col flex-10 text-right mx-6 items-center text-center lg:items-end">
          <Heading
