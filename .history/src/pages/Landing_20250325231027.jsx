...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden px-12">
      ...
      <img
        src={patient1}
        className="h-[380px] object-cover rounded-xl mx-auto mt-[-60px] z-[-1] mb-8 max-w-[1200px] w-full px-12"
        style={{
          maskImage:
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[1200px] m-auto px-12">
