    ...
    <main className="flex flex-col overflow-hidden ">
      ...
      >
        <p className=" relative">
          Speak up, stay
          <Quotes
            className="absolute left-[-110px] top-[-30px] sm:left-[-190px] sm:top-[-30px] rotate-183"
            weight="fill"
            size={90}
          />
          <Quotes
            className="absolute right-[-100px] bottom-[-270pxpx] sm:right-[-215px] sm:bottom-[-287px] rotate-2"
            weight="fill"
            size={160}
          />
        </p>
