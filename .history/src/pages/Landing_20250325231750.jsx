  ...
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-8 mb-10 lg:max-w-[70vw] items-center lg:items-center lg:self-center text-center">
        <Heading
          className="text-[47px] sm:text-7xl md:text-8xl md:leading-24 -translate-x-15 sm:-translate-x-30"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] text-right sm:text-7xl md:text-8xl sm:translate-x-30"
