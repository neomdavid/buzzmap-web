...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex items-center w-full flex-col text-7xl px-8 mb-10 lg:max-w-[70vw] lg:self-center text-center">
        <Heading
          className="text-[47px] sm:text-7xl md:text-8xl md:leading-24 
    sm:text-center lg:text-left lg:self-start"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] sm:text-7xl md:text-8xl 
    sm:text-center lg:text-right lg:self-end"
