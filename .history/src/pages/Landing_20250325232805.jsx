  ...
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex items-center w-full flex-col text-7xl px-8 mb-10 lg:max-w-[70vw] lg:items-center lg:self-center text-center">
        <Heading
          className="text-6xl text-left w-full sm:text-6xl md:text-8xl md:leading-24 lg:-translate-x-30"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-6xl text-right w-full sm:text-6xl md:text-8xl lg:translate-x-30"
