...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex items-center w-full flex-col text-7xl px-8 mb-10 lg:max-w-[1500px] lg:items-center lg:self-center text-center">
        <Heading
