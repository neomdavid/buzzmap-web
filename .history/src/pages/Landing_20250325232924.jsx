...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex items-center w-full flex-col text-7xl px-8 mb-10 max-w-[1500px] m-auto lg:items-center lg:self-center text-center">
        <Heading
          className="text-6xl text-left w-full sm:text-7xl md:text-8xl md:leading-24 lg:-translate-x-30"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-6xl text-right w-full sm:text-7xl md:text-8xl lg:translate-x-30"
      ...
      <img
        src={patient1}
        className="h-[380px] object-cover rounded-xl mx-auto mt-[-60px] z-[-1] mb-8 max-w-[1200px] w-full px-6 sm:px-12"
        style={{
          maskImage:
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[1200px] m-auto px-6 sm:px-12">
