...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-8 mb-10 lg:max-w-[100vw] lg:items-center lg:self-center text-center">
        <Heading
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[1200px] m-auto px-6 sm:px-12">
        <div className=" bg-accent h-110 mb-8 sm:mb-0 sm:flex-8 sm:h-auto">
          hello
        </div>
