...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[95vw] m-auto px-6 sm:px-12">
        <div className=" border-1 border-primary rounded-lg h-110 mb-6 lg:mb-0 sm:flex-8 lg:h-auto lg:bg-green-100 flex items-center justify-center">
          Map Placeholder
        </div>
