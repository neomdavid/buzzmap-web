...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      ...
      <div className="relative overflow-hidden bg-primary h-[360px] max-w-[95vw] rounded-3xl">
        <img
          src={patient1}
          className=" rounded-2xl object-cover mx-auto mt-[-60px] z-[-1] mb-8  w-full px-6 sm:px-12"
          style={{
            maskImage:
