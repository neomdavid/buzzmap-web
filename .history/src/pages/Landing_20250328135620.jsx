...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      ...
      <div
        className="h-[380px] max-w-[95vw] w-full bg-base-primary px-6 sm:px-12 mx-auto rounded-4xl overflow-hidden"
        style={{
          maskImage:
      ...
      >
        <img src={patient1} className="w-full h-full object-cover" />
      </div>
