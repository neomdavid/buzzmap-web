...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      ...
      <div className="relative overflow-hidden bg-primary h-[360px]  rounded-3xl">
        <img
          src={patient1}
          className=" rounded-2xl object-cover mx-auto mt-[-60px] z-[-1] mb-8 max-w-[95vw] w-full px-6 sm:px-12"
          style={{
            maskImage:
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[95vw] m-auto px-6 sm:px-12 gap-x-4">
        <div className=" border-1 border-primary rounded-lg h-100 mb-4 lg:mb-0 lg:h-auto lg:flex-8  flex items-center justify-center">
          Map Placeholder
        </div>
