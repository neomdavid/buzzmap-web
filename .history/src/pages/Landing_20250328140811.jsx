...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl px-20 mb-10 lg:max-w-[70vw] lg:items-center lg:self-center text-center">
        <Heading
          className="text-[47px] text-left sm:text-7xl md:text-8xl md:leading-24 lg:-translate-x-30"
      ...
      <img
        src={patient1}
        className="h-[380px] object-cover rounded-3xl mx-auto mt-[-60px] z-[-1] mb-8 max-w-[95vw] w-full px-6 sm:px-12"
        style={{
          maskImage:
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[95vw] m-auto px-6 sm:px-12 gap-x-4">
