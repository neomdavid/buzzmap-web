...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl max-w-[90vw] px-8 mb-10 lg:max-w-[70vw] lg:items-center lg:self-center text-center">
        <Heading
