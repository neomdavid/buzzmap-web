  ...
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl  px-10 mb-10 lg:max-w-[70vw] lg:items-center lg:self-center text-center">
        <Heading
          className="text-[47px] text-left sm:text-7xl md:text-8xl md:leading-24 lg:-translate-x-50 xl:-translate-x-120"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] text-right sm:text-7xl md:text-8xl lg:translate-x-50"
