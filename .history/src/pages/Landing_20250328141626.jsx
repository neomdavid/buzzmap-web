...
const Landing = () => {
  return (
    <main className="flex flex-col overflow-hidden ">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl  px-10 mb-10 lg:max-w-[70vw] lg:items-center lg:self-center text-center">
        <Heading
          className="text-[47px] text-left sm:text-7xl md:text-8xl md:leading-24 lg:-translate-x-50 xl:-translate-x-65 xl:text-9xl xl:leading-100"
          text="Buzzing /with awareness/"
        />
        <Heading
          className="text-[47px] text-right sm:text-7xl md:text-8xl lg:translate-x-50 xl:translate-x-65 xl:text-9xl"
      ...
      <img
        src={patient1}
        className="h-[380px] object-cover rounded-3xl mx-auto mt-[-60px] z-[-1] mb-8 max-w-[95vw] w-full px-6 sm:px-6"
        style={{
          maskImage:
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[95vw] m-auto px-6 sm:px-6 gap-x-4">
        <div className=" border-1 border-primary rounded-lg h-100 mb-6 lg:mb-0 lg:h-auto lg:flex-10  flex items-center justify-center">
          Map Placeholder
        </div>
      ...
      <article
        ...
        className="z-20 bg-primary mt-[-5px] pt-22 pb-50 w-full flex justify-center text-6xl sm:text-7xl items-center flex-col text-white"
      >
