  ...
  return (
    <main className="flex flex-col overflow-hidden mt-12">
      <div className="text-primary font-[Koulen] uppercase flex flex-col text-7xl  px-10 mb-10 lg:max-w-[80vw] lg:items-center lg:self-center text-center">
        ...
        />
        <Heading
          className="text-[46px] text-right sm:text-7xl md:text-8xl lg:translate-x-50 xl:translate-x-50 xl:text-9xl"
      ...
      <article className="bg-primary mt-8 flex flex-col items-center py-20">
        ...
        <div className="grid grid-cols-2 md:flex justify-center flex-wrap gap-6 px-4">
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-30 left-8 lg:top-37 lg:left-13.5"
            subtextPosition="top-57 left-8 lg:top-64 lg:left-16"
            categoryPosition="top-20 left-8 lg:top-26 lg:left-16"
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-18 left-0 lg:top-32.5"
            subtextPosition="top-53 left-9.5 lg:top-60  lg:left-18"
            categoryPosition="top-6 left-[40px] lg:left-21.5 lg:top-21.5"
            bgColor="bg-base-200"
            to="/sanitation"
            titleAlign="center"
            subtextAlign="center"
