      ...
      <article className="bg-primary mt-8 flex flex-col items-center py-20">
        ...
        <div className="grid grid-cols-2 md:flex justify-center flex-wrap gap-6 px-4">
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-30 left-8 lg:top-37 lg:left-10 xl:top-37 xl:left-11.5 2xl:top-40"
            subtextPosition="top-57 left-8 lg:top-67 lg:left-12.5 xl:top-72 xl:left-14"
