  ...
  return (
    <main className="flex flex-col overflow-hidden mt-12">
      ...
      <section className="flex flex-col lg:flex-row  justify-center max-w-[95vw] m-auto px-6 sm:px-6 gap-x-4">
        <div className="rounded-xl overflow-hidden h-100 mb-6 lg:mb-0 lg:h-auto lg:flex-10  flex items-center justify-center">
          <DengueMap />
        </div>
      ...
      <article className="bg-primary mt-8 flex flex-col items-center py-20">
        ...
        <div className="grid grid-cols-2 md:flex justify-center flex-wrap gap-6 px-4">
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-30 left-8 lg:top-37 lg:left-10 xl:top-37 xl:left-11.5 2xl:top-45 2xl:left-14"
            subtextPosition="top-57 left-8 lg:top-67 lg:left-12.5 xl:top-72 xl:left-14 2xl:top-80 2xl:left-16.5"
            categoryPosition="top-20 left-8 lg:top-26 lg:left-12.5 xl:top-26 xl:left-13 2xl:top-33 2xl:left-14"
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-18 left-0 lg:top-24.5 xl:left-2"
            subtextPosition="top-53 left-9.5 lg:top-63.5  lg:left-18 xl:left-26.5 xl:top-72.5"
            categoryPosition="top-6 left-[40px] lg:left-21.5 lg:top-13.5 lg:left-26.5 lg:top-13.5"
            bgColor="bg-base-200"
            to="/sanitation"
            titleAlign="center"
            subtextAlign="center"
