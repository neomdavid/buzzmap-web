      ...
      <article className="bg-primary mt-8 flex flex-col items-center py-20">
        ...
        <div className="grid grid-cols-2 md:flex justify-center flex-wrap gap-6 px-4">
          ...
          <AltPreventionCard
            ...
            subtextPosition="top-53 left-9.5 lg:top-63.5  lg:left-18 xl:left-26.5 xl:top-72.5 2xl:top-84 2xl:left-27.5 "
            categoryPosition="top-6 left-[40px] lg:left-21.5 lg:top-13.5 lg:left-26.5 lg:top-13.5 2xl:top-30 2xl:left-29"
            bgColor="bg-base-200"
            to="/sanitation"
            titleAlign="center"
            subtextAlign="center"
