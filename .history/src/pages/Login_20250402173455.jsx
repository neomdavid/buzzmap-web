...
const Login = () => {
  return (
    <main className="relative">
      ...
      <section className="mb-4 absolute right-0 top-0 h-[100vh] text-white w-[60vw] bg-primary py-10 px-25 flex flex-col items-center text-center text-lg  ">
        ...
        <form className="flex flex-col">
          <div className="flex">
            <div className="flex flex-col gap-y-2">
              ...
              <input
                type="text"
                className="bg-base-200 py-2.5 px-3.5 rounded-2xl focus:outline-none"
                placeholder="hello"
              />
            </div>
          </div>
