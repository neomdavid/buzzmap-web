      ...
      <section className="absolute right-0 top-0 h-[100vh] text-white w-[60vw] bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-lg  ">
        ...
        <form className="flex flex-col gap-y-6 w-full">
          ...
          <div className="flex items-center gap-x-2">
            <input
              type="checkbox"
              className="w-6 h-6 appearance-none border border-gray-300 rounded-full checked:bg-blue-500 checked:border-transparent focus:outline-none cursor-pointer relative flex items-center justify-center 
    before:content-['✔'] before:text-white before:absolute before:opacity-0 checked:before:opacity-100 checked:before:scale-100 before:scale-50 before:transition-transform"
            />
