...
const Login = () => {
  ...
  <label className="relative flex items-center cursor-pointer">
    {/* Hidden checkbox - critical to have peer class */}
    <input type="checkbox" className="sr-only peer" />
    
    {/* Custom checkbox circle - now with !important styles */}
    <span className="flex items-center justify-center h-5 w-5 rounded-full border-2 border-gray-300 peer-checked:border-primary peer-checked:bg-primary transition-all duration-200">
      {/* Checkmark with forced white color */}
      <svg 
    ...
    <span className="ml-2 text-sm select-none">I agree to the terms</span>
  </label>
</div>
        </form>
      </section>
