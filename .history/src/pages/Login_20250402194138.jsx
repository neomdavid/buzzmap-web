    ...
    <main className="relative">
      ...
      <section className="absolute right-0 top-0 h-[100vh] text-white w-[60vw] bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-xl  ">
        ...
        <form className="flex flex-col items-center gap-y-8 w-full">
          ...
          <button className="bg-white font-extrabold shadow-[2px_6px_3px_rgba(0,0,0,0.20)] font-bold text-primary w-xs py-3 px-4 rounded-2xl hover:cursor-pointer hover:bg-base-200 transition-all duration-300">
            Sign Up
          </button>
        </form>
      </section>
