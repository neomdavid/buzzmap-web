        ...
        <form className="flex flex-col items-center gap-y-8 w-full">
          ...
          <div className="flex justify-center text-lg items-center gap-x-2">
            <input
              type="checkbox"
              defaultChecked
              className="mb-2 checkbox checkbox-lg border-white bg-transparent checked:bg-transparent checked:text-white checked:border-white "
            />
            <label className="">I agree to the Terms and Conditions</label>
          </div>
          <button className="bg-white mb-1 font-extrabold shadow-[2px_6px_3px_rgba(0,0,0,0.20)] font-bold text-primary w-xs py-3 px-4 rounded-2xl hover:cursor-pointer hover:bg-base-200/60 transition-all duration-300">
            Sign Up
          </button>
