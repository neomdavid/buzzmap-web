...
const Login = () => {
  return (
    <main className="relative h-[100vh]">
      ...
      <img
        src={womanLowHand}
        className="absolute right-[59vw] bottom-[-25px] w-203 xl:w-230 2xl:w-250"
      />

      <section className="absolute right-0 top-0 h-[100vh] text-white w-[60vw] bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-xl xl:w-100  ">
