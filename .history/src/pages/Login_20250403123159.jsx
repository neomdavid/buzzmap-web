...
const Login = () => {
  return (
    <main className="relative h-[100vh] overflow-hidden">
      ...
      <img
        src={womanLowHand}
        className="absolute hidden right-[59vw] bottom-[-25px] w-203 xl:w-260 xl:right-249 2xl:w-270 "
      />

      <section className="absolute right-0 top-0 h-[100vh] text-white w-[60vw] bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-xl xl:w-250  ">
