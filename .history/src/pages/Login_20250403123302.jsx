...
const Login = () => {
  return (
    <main className="relative h-[100vh] overflow-hidden">
      ...
      <section className="absolute right-0 top-0 h-[100vh] text-white  bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-xl w-[100vw] lg:w-[60vw] xl:w-250  ">
