...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="  right-0 top-0  text-white  bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-xl w-[100vw]
      lg:absolute lg:h-[100vh] lg:w-[60vw] xl:w-250  "
      >
