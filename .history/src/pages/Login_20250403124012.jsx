...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="mx-20 mt-22  text-white  bg-primary py-10 px-25 flex flex-col justify-center items-center text-center text-md lg:text-xl w-[100vw]
      lg:m-0 lg:absolute lg:right-0 lg:top-0  lg:h-[100vh] lg:w-[60vw] xl:w-250  "
      >
        <h1 className="mb-4 text-7xl lg:text-8xl lg:text-red-100">
          Join buzzmap!
        </h1>
        <p className="mb-6">
        ...
        <form className="flex flex-col items-center gap-y-8 w-full">
          <div className="flex flex-row gap-y-6 gap-x-4 w-full">
          ...
          <button className="text-md bg-white font-extrabold shadow-[2px_6px_3px_rgba(0,0,0,0.20)] font-bold text-primary w-xs py-3 px-4 rounded-2xl hover:cursor-pointer hover:bg-base-200/60 transition-all duration-300">
            Sign Up
          </button>
