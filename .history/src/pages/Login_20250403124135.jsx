...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="mx-20 mt-22 rounded-2xl  text-white  bg-primary py-12 px-10 lg:px-25 flex flex-col justify-center items-center text-center text-md lg:text-xl w-[100vw]
