...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="mx-20 mt-22 rounded-2xl shadow-[2px_6px_3px_rgba(0,0,0,0.20)]  text-white  bg-primary py-12 px-[7%] lg:px-25 flex flex-col justify-center items-center text-center text-lg lg:text-xl w-[100vw]
