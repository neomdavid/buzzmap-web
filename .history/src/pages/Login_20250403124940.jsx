...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="w-[80vw] mt-25 rounded-2xl shadow-[4px_4px_8px_rgba(0,0,0,0.40)]  text-white  bg-primary py-12 px-[7%] lg:px-25 flex flex-col justify-center items-center text-center text-lg lg:text-xl
