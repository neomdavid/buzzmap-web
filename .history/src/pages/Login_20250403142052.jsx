...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="w-[87vw] max-w-220 mt-25 rounded-2xl shadow-[4px_4px_8px_rgba(0,0,0,0.40)]  text-white  bg-white py-12 px-[7%] lg:px-25 flex flex-col justify-center items-center text-center text-lg lg:text-xl
          ...
          <div className="mt-[-5px] flex  w-full justify-between">
            <div className=" mb-4 flex justify-center  items-center gap-x-2">
              <input
                type="checkbox"
                defaultChecked
                className="checkbox checkbox-lg border-white bg-transparent checked:bg-transparent checked:text-primary checked:border-white "
              />
