...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <section
        className="w-[87vw] max-w-220 mt-25 rounded-2xl shadow-[4px_4px_8px_rgba(0,0,0,0.40)]  text-primary  bg-white py-12 px-[7%] lg:px-25 flex flex-col justify-center items-center text-center text-lg lg:text-xl
      ...
      >
        ...
        <form className="flex flex-col items-center gap-y-3 lg:gap-y-8 w-full">
          ...
          <div className="flex w-[60%] gap-x-4 mb-[-8px] ">
            <div className="flex-1 border-t-1 border-primary/60 mt-3 text-primary ">
              -
            </div>
            <div className="text:sm lg:text-[13px]">or Login With</div>
            <div className="flex-1 text-white border-t-1 border-primary/60 mt-3 text-primary ">
              -
            </div>
          </div>
