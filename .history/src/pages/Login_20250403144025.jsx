  ...
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      >
        ...
        <p className="mb-6">
          <span className="font-bold mb-4 ">Login</span> to stay informed and
          help prevent dengue outbreaks in your community.
        </p>
        <form className="flex flex-col items-center gap-y-6 lg:gap-y-8 w-full">
          ...
          <div className="mt-[-1px] mb-8 flex  w-full justify-between">
        ...
        <p className="mt-10 text-md lg:text-[14px]">
