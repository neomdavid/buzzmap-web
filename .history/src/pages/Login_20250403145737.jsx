...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      ...
      <div className="absolute z-[-1000] text-primary bg-primary w-10 top-0 bottom-0 left-0">
        h
      </div>
      <img
        src={manHighHand}
        className="absolute hidden left-[-2px] bottom-[-25px] w-203 lg:block xl:w-250 xl:right-249 2xl:w-260 "
      />
      ...
      >
        ...
        <form className="flex flex-col items-center gap-y-6 lg:gap-y-8 w-[85%]">
          ...
          <button className="bg-primary mb-4 font-extrabold shadow-[2px_6px_3px_rgba(0,0,0,0.20)] font-bold text-white w-xs py-3 px-4 rounded-2xl hover:cursor-pointer hover:bg-base-200/60 transition-all duration-300">
            Login
          </button>
