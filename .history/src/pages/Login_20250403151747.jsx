...
const Login = () => {
  return (
    <main className="flex justify-center items-center relative h-[100vh] overflow-hidden">
      <div className="absolute left-14 xl:left-18 top-8">
        <LogoNamed
          textSize="text-[28px] lg:text-6xl"
          iconSize="h-11 w-11 lg:h-18 lg:w-18"
        />
      </div>
      ...
      >
        ...
        <form className="flex flex-col items-center gap-y-6 lg:gap-y-8 w-[85%]">
          <CustomFormInput label="Email" type="email" theme="light" />
          <CustomFormInput
            label="Password"
            type="password"
            theme="light"
