    ...
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="px-6 py-14 pt-24 w-full bg-primary flex flex-col text-white items-start">
        ...
        <div className="flex  w-full mt-24">
          <figure className="border-2 border-red-100 rounded-md w-[35%]"></figure>
          <figure className="flex ">
            <div className="bg-secondary p-2 text-primary rounded-full">
              <ShieldCheck size={36} />
            </div>
            <div className="flex flex-col">
              <p className="font-semibold">Personal Prevention</p>
              <p className="">
                Learn simple daily habits to protect yourself from dengue, from
                using repellents to recognizing early symptoms.
              </p>
            </div>
          </figure>
        </div>
