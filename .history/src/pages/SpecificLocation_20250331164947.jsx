...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col items-between justify-center text-white z-10000000 absolute left-0 bottom-0 top-0 bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-4 py-8">
