...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col justify-center text-white z-10000000 absolute left-0 bottom-0 top-0 bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-4 py-8">
        ...
        <div>
          ...
          />
          <p className="text-[27px] mr-4 ml-1 mb-4 tracking-wide leading-8">
        ...
        <div className="flex flex-col gap-y-4 text-[12px] text-primary">
          <SecondaryButton
