...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col text-white z-10000000 absolute  bottom-0  bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-4 py-8 ">
        ...
        <div>
          ...
          <img
            src={UPBuilding}
            className="w-full h-[20vh] object-cover rounded-2xl mb-4"
          />
