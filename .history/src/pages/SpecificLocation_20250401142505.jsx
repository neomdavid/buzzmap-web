...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col text-white  z-10000000 absolute  bottom-0 h-[100vh]  bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-6 py-8 md:border md:border-red-100 md:w-[35vw]">
