...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col justify-around text-white z-10000000 absolute bottom-0 h-[100vh] bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-5 md:border md:border-red-100 md:w-[35vw] lg:bg-white">
        ...
        <div className="flex flex-col  ">
          <p className="text-[16px] font-semibold mb-1 md:text-[14px]">
        ...
        <div className="flex flex-col items-center mx-2 gap-y-2 text-[12px] text-primary">
          <SecondaryButton text="Report a Dengue Case" className="h-[25%]" />
          <SecondaryButton
            text="View Reports by the Community"
            className="h-[25%]"
          />
          <SecondaryButton text="Prevention Tips" className="h-[25%]" />
        </div>
