...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <aside className="flex flex-col justify-around py-4 text-white z-10000000 absolute bottom-0 h-[100vh] bg-primary w-[28vw] shadow-[10px_0px_10px_rgba(0,0,0,0.3)] px-5 md:border md:border-red-100 md:w-[35vw] lg:bg-white">
        <div className="flex flex-col">
          ...
          <img
            src={UPBuilding}
            className="w-full object-cover rounded-2xl mb-5 md:h-[20vh]"
          />
          <p className="text-[27px] mr-4 ml-1 mb-5 tracking-wide leading-8 md:text-[23px]">
        ...
        <div className="flex flex-col  ">
          <p className="text-[16px] text-center font-semibold mb-1 md:text-[14px]">
