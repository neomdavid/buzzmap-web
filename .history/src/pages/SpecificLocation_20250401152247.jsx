...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] ">
      ...
      <SideNavDetails />
      <article className="absolute z-100000 flex flex-col justify-left text-primary right-0 left-[38vw] bottom-0">
        <p className="text-2xl font-semibold shadow-md text-left">
          Most Recent Reports
        </p>
