...
const SpecificLocation = () => {
  return (
    <main className="  relative bg-white text-2xl mt-[-69px] w-[100vw]  ">
      <div className="w-full h-[100vh]">
        <DengueMap />
      </div>
      <SideNavDetails />
      <article className="absolute overflow-hidden z-100000 flex flex-col items-start text-primary top-0 right-0">
