...
const SpecificLocation = () => {
  return (
    <main className="  relative bg-white text-2xl mt-[-69px]  ">
      <div className="w-full h-[100vh]">
        <DengueMap />
      </div>
      <SideNavDetails />
      <article className="absolute overflow-hidden z-100000 flex flex-col items-start text-primary bottom-0 left=[20vw]">
