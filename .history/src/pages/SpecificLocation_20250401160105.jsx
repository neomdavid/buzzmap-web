...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px]  ">
      ...
      <SideNavDetails />
      <article className="absolute overflow-hidden z-100000 flex flex-col items-start text-primary right-10 left-[38vw] bottom-5 bg-white">
        <p className="text-[20px] font-semibold text-left mb-2">
          Most Recent Reports
        </p>
        {/* Scrollable container */}
        <section className="flex flex-row-reverse justify-right bg-red-100 gap-x-2 text-[13px] overflow-x-auto w-[80vw] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
          <RecentReportCard
