...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px] relative">
      ...
      <SideNavDetails />
      <article
        className="absolute z-50 flex flex-col items-end right-10 bottom-5 bg-white"
        style={{ maxWidth: "62vw" }}
      >
        ...
        <section className="flex flex-row-reverse gap-x-2 text-[13px] overflow-x-auto w-full max-w-[62vw] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
          <RecentReportCard
