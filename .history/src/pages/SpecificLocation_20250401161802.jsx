...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px]  ">
      ...
      <SideNavDetails />
      <article className="absolute overflow-x-scroll z-100000 flex flex-col items-end text-primary right-10  bottom-5  max-w-200">
        <p className="text-[20px] font-semibold text-left mb-2 w-full">
          Most Recent Reports
        </p>
        {/* Scrollable container */}
        <section className="flex gap-x-2 text-[13px] overflow-x-auto  scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
          <RecentReportCard
