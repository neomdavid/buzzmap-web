...
const SpecificLocation = () => {
  return (
    <main className="text-2xl mt-[-69px]  ">
      ...
      <SideNavDetails />
      <article className="absolute overflow-x-scroll z-100000 flex flex-col  text-primary right-[0]  bottom-5 md:max-w-[60vw]  lg:max-w-[62vw]  xl:max-w-[69vw] 2xl:bg-white 2xl:max-w-[72vw] ">
