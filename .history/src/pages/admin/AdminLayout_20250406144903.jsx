    ...
    <main className="flex ">
      <aside className="fixed flex flex-col top-0 bottom-0 w-90 shadow-sm py-8 px-8">
        ...
        <nav className="flex flex-col justify-center w-full text-primary gap-y-2">
          <NavLink className="flex items-center bg-red-100 py-3 px-3 gap-x-3 rounded-xl hover:bg-gray-200">
            <House weight="fill" size={20} />
            <p className="font-extrabold text-lg">Dashboard</p>
          </NavLink>
          <NavLink className="flex items-center  text-gray-500 py-3 px-3 gap-x-3 rounded-xl hover:bg-gray-200">
