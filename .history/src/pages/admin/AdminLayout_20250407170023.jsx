  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-auto w-full">
        {/* Top navbar */}
        {/* Top navbar */}
        <div className="w-full fixed top-0 z-20 px-7 py-6 bg-white flex justify-between items-center shadow-sm">
        ...
        <section
          className={`px-6 py-4 mt-[90px] ${
            currentRoute === "/admin/dashboard" ? "" : "md:mt-[70px]"
