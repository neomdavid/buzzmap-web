...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <aside
        className={`fixed z-40 top-0 left-0 h-full w-80 bg-white shadow-md p-8 flex flex-col justify-between transition-transform duration-300 md:relative md:translate-x-0 ${
      ...
      <div className="flex flex-1 flex-col overflow-auto w-full">
        {/* Top navbar */}
        <div className="w-full px-7 py-6  bg-white flex justify-between items-center">
          ...
          <div className="flex bg-neutral-content items-center gap-x-4 ml-auto">
        ...
        <section
          className={`px-6 py-4 bg-neutral-content z-[-10000]  ${
            currentRoute === "/admin/dashboard" ? "" : "md:mt-[-57px]"
          }  md:ml-2 lg:ml-4 text-primary`}
        >
          <Outlet />
        </section>
      </div>
