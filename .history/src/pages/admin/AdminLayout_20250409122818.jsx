...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className=" z-10000 flex flex-1 flex-col overflow-auto w-full">
        {/* Top navbar */}
        <div className="bg-transparent z-1 w-full px-7 py-6  bg-neutral-content flex justify-between items-center">
