  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-auto w-full">
        {/* Top navbar */}
        <div className="  w-full px-7 py-6  bg-neutral-content flex justify-between items-center z-[-100000]">
          ...
          <div className="z-10000000000 flex items-center gap-x-4 ml-auto">
