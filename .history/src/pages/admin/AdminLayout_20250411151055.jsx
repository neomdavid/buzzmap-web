...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className=" flex flex-1 flex-col h-20 overflow-auto w-full">
        {/* Top navbar */}
        <div className="z-10000000000 bg-transparent  w-full px-7 py-6  bg-neutral-content flex justify-between items-center">
        ...
        <section
          className={`z-1000000000000 px-6 py-4 bg-neutral-content z-[-10000]  ${
