      ...
      <article className="flex flex-col">
        <section className="flex flex-col">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col gap-y-2 bg-white text-lg border-l-7 py-4 px-6 rounded-2xl shadow-sm">
              <p className="text-2xl text-base-content font-semibold mb-1">
                Scheduled
              </p>
