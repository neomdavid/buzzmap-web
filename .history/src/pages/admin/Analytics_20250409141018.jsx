                ...
                <div className="flex justify-between">
                  <div className="flex items-center gap-x-3 ">
                    <div className="text-warning ">
                      <IconHourglassEmpty size={15} stroke={2} />
                    </div>
                    <p className="text-gray-500">Data collection</p>
                  </div>
                  <button className="text-xs bg-base-content text-white font-light p-2 rounded-full hover:cursor-pointer hover:bg-base-content/70 transition-all duration-200">
