  ...
  return (
    <main className=" flex flex-col w-full ">
      ...
      <article className="flex flex-col">
        ...
        <div className="flex flex-col shadow-sm shadow-lg p-4 rounded-lg">
          <section className="text-base-content text-4xl font-bold">
            Pattern Recognition Alerts
          </section>
          <div className=" relative border-2 border-error rounded-3xl p-6 text-black">
            <p className="absolute left-0 top-0 text-nowrap bg-error rounded-xl font-semibold text-white p-2">
