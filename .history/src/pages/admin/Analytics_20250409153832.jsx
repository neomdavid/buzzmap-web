      ...
      <article className="flex flex-col">
        ...
        <div className="flex shadow-sm shadow-lg p-4 rounded-lg">
          ...
          <section className="flex flex-14 flex-col">
            ...
            <div className=" relative border-[2.5px] border-error rounded-3xl p-6 text-black">
              <p className="absolute left-[-5px] top-[-5px] text-nowrap bg-error rounded-2xl font-semibold text-white p-2 px-4">
