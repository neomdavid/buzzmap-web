    ...
    <main className=" flex flex-col w-full ">
      ...
      <article className="flex flex-col">
        ...
        <div className="flex shadow-sm shadow-lg p-4 rounded-lg">
          ...
          <section className="flex flex-19 flex-col">
            <p className="text-base-content text-4xl font-bold">
              Pattern Recognition Alerts
            </p>
            <div className=" relative border-[2px] border-error rounded-4xl p-4 pt-12 text-black">
              <p className="absolute text-lg left-[-5px] top-[-5px] text-nowrap bg-error rounded-2xl font-semibold text-white p-2 px-4">
                Dengue Spike in Holy Spirit
              </p>
              <p>
                <span className="font-bold">Last 2 Weeks</span>
              </p>
            </div>
          </section>
        </div>
