...
const Analytics = () => {
  return (
    <main className=" flex flex-col w-full ">
      <p className="flex justify-center text-5xl font-extrabold mb-12  text-center md:justify-start md:text-left  ">
        Analytics
      </p>
      <article className="flex flex-col">
        ...
        <div className="flex flex-col gap-6 gap-y-14 lg:flex-row shadow-sm shadow-lg p-6 py-8 rounded-lg">
          <section className="flex flex-col flex-26">
          ...
          <section className="grid flex flex-19 flex-col gap-y-5">
            <p className="mb-2 text-base-content text-4xl font-bold">
