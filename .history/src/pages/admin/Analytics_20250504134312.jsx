  ...
  return (
    <main className=" flex flex-col w-full ">
      ...
      <article className="flex flex-col">
        ...
        <div className="flex flex-col gap-6 gap-y-18 lg:grid lg:grid-cols-50 shadow-sm shadow-lg p-6 py-8 rounded-lg">
          <section className="flex  lg:cols-span-30 flex-col">
          ...
          <section className="grid flex lg:cols-span-20 flex-col gap-y-5">
