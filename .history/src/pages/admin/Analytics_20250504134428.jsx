  ...
  return (
    <main className=" flex flex-col w-full ">
      ...
      <article className="flex flex-col">
        ...
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-50 shadow-sm shadow-lg p-6 py-8 rounded-lg">
          <section className="flex flex-col lg:col-span-35">
          ...
          <section className="flex flex-col lg:col-span-15 gap-y-5">
