        ...
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-12 shadow-sm shadow-lg p-6 py-8 rounded-lg">
          ...
          <section className="flex flex-col lg:col-span-5 gap-y-5">
            ...
            <Swiper
              ...
              className="w-full h-[300px]" // Add a height to the Swiper for visibility
            >
            ...
            <div className="flex justify-between mt-4">
              <button
                onClick={handlePrev}
                className="bg-primary text-white p-3 rounded-full hover:bg-primary/80 focus:outline-none"
              >
                ↑ Up
              </button>
              <button
