      ...
      <article className="flex flex-col">
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-12 shadow-sm shadow-lg p-6 py-8 rounded-lg">
          ...
          <section className="flex flex-col lg:col-span-5">
            ...
            <div className="flex gap-4 h-[360px]"> {/* Increased height to accommodate spacing */}
              {/* Swiper Carousel */}
              <div className="flex-1">
                ...
                >
                  {alerts.map((alert, index) => (
                    <SwiperSlide key={index} className="!h-auto"> {/* Allow slides to respect spacing */}
                      <div className="pb-4 h-full"> {/* Added padding bottom for spacing */}
                        <AlertCard {...alert} />
                      </div>
                    </SwiperSlide>
                  ))}
