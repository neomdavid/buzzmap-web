  ...
  return (
    <main className=" flex flex-col w-full ">
      ...
      <article className="flex flex-col">
        ...
        <div className="flex flex-col gap-12 lg:grid lg:grid-cols-12 shadow-sm shadow-lg p-6 py-8 rounded-lg">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 shadow-sm shadow-lg p-6 py-8 rounded-lg">
