      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 ">
        ...
        >
          ...
          <div className="flex flex-col gap-4 p-6">
            ...
            {/* Message Input */}
            <div className="flex flex-col gap-2">
              <label className="font-medium text-primary">Alert Message</label>
              <textarea
                value={message}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <label className="font-medium text-primary">Date</label>
                <div className="relative">
                  <input
                    type="date"
                    value={date}
              ...
              <div className="flex flex-col gap-2">
                <label className="font-medium text-primary">Time</label>
                <div className="relative">
                  <input
                    type="time"
                    value={time}
