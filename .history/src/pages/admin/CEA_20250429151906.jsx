    ...
    <main className="flex flex-col w-full max-w-6xl mx-auto p-4 md:p-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 ">
        <form
          ...
          className="flex flex-col rounded-2xl overflow-hidden shadow-md border border-gray-200 bg-white"
        >
          ...
          <div className="flex flex-col gap-4 p-6">
            ...
            <div className="w-full flex justify-center mt-4">
              <button
                type="submit"
                className="bg-primary hover:bg-primary-dark transition-colors rounded-full font-semibold text-white py-1.5 px-8 text-lg shadow-md"
              >
                Send Alert
              </button>
            </div>
