        ...
        >
          ...
          <div className="flex flex-col gap-4 p-6">
            ...
            <div className="w-full flex justify-center mt-4">
              <button
                type="submit"
                className="bg-primary hover:bg-primary/90 duration-200 transition-all rounded-full font-semibold text-white py-1.5 px-8 text-lg shadow-md hover:cursor-pointer"
              >
                Send Alert
              </button>
            </div>
