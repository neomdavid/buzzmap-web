        ...
        <article className="flex flex-col">
          ...
          <div className="flex flex-col bg-base-200 rounded-3xl gap-y-3 px-6 py-6 pt-15 mt-[-32px] z-[-4]">
            ...
            <div className="flex items-center gap-x-3">
              ...
              <div className="h-4 w-4 rounded-full bg-base-content" />
              <div className="h-4 w-4 rounded-full bg-info" />
              <div className="h-4 w-4 rounded-full bg-info-content" />
              <div className="h-4 w-4 rounded-full bg-primary-content" />
