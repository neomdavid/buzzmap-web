    ...
    <main className="flex flex-col w-full ">
      ...
      <section className="grid grid-cols-2 gap-4">
        <article className="flex flex-col">
          <div className="flex flex-col bg-primary-content text-white rounded-3xl py-4 pb-3 px-10">
            <p className=" text-xl">Total Reports</p>
            <h1 className="text-8xl">125</h1>
          </div>
          <div className="flex flex-col bg-base-200 rounded-3xl gap-y-3 px-6 py-4 pt-15 mt-[-34px] z-[-4]">
