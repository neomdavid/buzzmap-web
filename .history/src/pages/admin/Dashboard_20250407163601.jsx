    ...
    <main className="flex flex-col w-full ">
      ...
      <section className="ml-1">
        ...
        <table className="w-full">
          <tr className="text-left text-[14px] text-base-content font-semibold">
            <th>Report ID</th>
            <th>Location</th>
            <th>Date</th>
            <th>Status</th>
          </tr>{" "}
          <tr className="text-black text-[13.5px]">
            <td>RPT-00123</td>
            <td>Barangay Commonwealth</td>
            <td>2025-03-01</td>
            <td>
              <div className="bg-success text-[12px] text-white font-semibold rounded-full py-1 text-center">
                Verified
              </div>
            </td>
          </tr>
