...
const Dashboard = () => {
  return (
    <main className="flex flex-col w-full ">
      ...
      <section className="flex lg:flex-4 flex-col lg:flex-row">
        <div className="w-full lg:flex-1 h-30">
          <DengueMap />
        </div>
        <div className="flex ">
          <div className="flex-1 bg-red-100 min-w-[150px]">s</div>
          <div className="bg-blue-100 ">swaefaweffawdawdwefwefawdawdawdafw</div>
        </div>
      </section>
    </main>
  );
