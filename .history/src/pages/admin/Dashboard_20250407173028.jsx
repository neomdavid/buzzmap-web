      ...
      <section className="flex mt-10 gap-3  flex-col lg:flex-row">
        ...
        <div className="flex gap-3 lg:flex-3">
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex flex-col gap-2 text-[13px] text-white font-light">
              <p className="bg-error py-2.5 px-3 rounded-2xl">
                Spike in Barangay Holy Spirit (30% Increase)
              </p>
              <p className="bg-warning py-2.5 px-3  rounded-2xl">
                Gradual rise in Barangay Payatas
              </p>

              <p className="bg-success py-2.5 px-3  rounded-2xl">
