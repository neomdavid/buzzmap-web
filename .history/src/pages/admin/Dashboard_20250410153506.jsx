...
const Dashboard = () => {
  return (
    <main className="flex flex-col w-full ">
      ...
      <section className="flex mt-10 gap-3  flex-col xl:flex-row">
        <div className="w-full shadow-sm h-52  xl:flex-2 xl:h-auto  rounded-xl overflow-hidden">
          <DengueMap />
        </div>
        <div className="flex gap-3 xl:flex-3">
