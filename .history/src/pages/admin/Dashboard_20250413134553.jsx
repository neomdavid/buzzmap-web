  ...
  return (
    <main className="flex flex-col w-full ">
      <div className=" bg-primary text-white flex flex-col p-6 rounded-2xl mb-4">
        ...
        <p className="text-lg">Today awdawis Friday, 7 March 2025</p>
      </div>
      ...
      <section className="flex mt-10 gap-4  flex-col ">
        <div className="w-full shadow-sm h-72  lg:flex-2   rounded-lg overflow-hidden">
          <DengueChartCard />
        </div>
