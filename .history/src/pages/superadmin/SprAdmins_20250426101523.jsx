  ...
  return (
    <main className="flex flex-col w-full">
      ...
      <dialog id="my_modal_4" className="modal">
        <div className="modal-box gap-6 text-lg w-10/12 max-w-5xl p-16 rounded-3xl flex flex-col">
          ...
          <div className="flex flex-col">
            <div className="w-full flex flex-col gap-1">
              <label className="text-primary font-bold">Confirm Password</label>
              <input className="p-3 bg-base-200 text-primary rounded-3xl border-none" />
            </div>
            {/* only show up for validation */}
          ...
          <div className="flex flex-col">
            <label className="text-primary font-bold">
              Profile picture{" "}
              <span className="text-[12px] font-normal italic">(Optional)</span>
            </label>
            <div className="flex items-center gap-4 rounded-full border-3 border-base-200 p-2 px-5">
              <btn className="bg-primary text-[11px] text-white px-4 py-2">
                Choose File
              </btn>
              <p className="text-[12px]">No File Chosen</p>
            </div>
          </div>
          <div className="w-full flex justify-end">
            <button className="bg-gray-400 text-white font-semibold p-6 py-3 rounded-3xl">
              Cancel
            </button>
            {/* make the bg of this button linear #245261 to #4AA8C7 */}
            <button className="bg-gray-300 text-white font-semibold">
              Create Admin
            </button>
          </div>
        </div>
