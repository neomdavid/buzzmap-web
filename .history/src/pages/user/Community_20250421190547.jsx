    ...
    <main className="pl-6 text-primary text-lg flex gap-x-6 max-w-[1350px] m-auto relative mt-12">
      <article className="flex-8 shadow-xl p-12 rounded-lg w-[100vw] lg:w-[65vw]">
        ...
        <Heading
          ...
          className="text-[47px] sm:text-8xl lg:text-8xl text-center mb-4 leading-21"
        />
        <p className="mt-[-10px] text-lg sm:text-xl sm:mt-0 text-center font-semibold text-primary mb-6">
