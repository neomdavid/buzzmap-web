  ...
  return (
    <main className="pl-6 text-primary text-lg flex gap-x-6 max-w-[1350px] m-auto relative mt-12">
      <article className="flex-8 shadow-xl p-12 rounded-lg w-[100vw] lg:w-[65vw]">
        ...
        {/* POST MODAL */}
        <dialog id="my_modal_3" className="modal text-lg text-primary">
          <div className="modal-box">
            <form method="dialog">
              {/* if there is a button in form, it will close the modal */}
              <button className="btn btn-sm text-2xl font-bold btn-circle btn-ghost absolute right-5 top-6">
                ✕
              </button>
            </form>
            <main>
              <p className="text-3xl font-semibold text-center">New Post</p>
            </main>
          </div>
        </dialog>
