...
<div className="flex items-center gap-2">
  <input
    type="text"
    className="bg-base-200 px-5 py-2 rounded-full w-full"
...
<div className="flex items-center gap-2">
  ...
  >
    ...
    <option value="Suspected Dengue Case">Suspected Dengue Case</option>
    <option value="Breeding Site Found">Breeding Ground Site</option>
  </select>
</div>

                  </div>
                </section>
                <hr className="text-gray-300 mt-6 mb-2" />
                <div className="flex flex-col p-2 gap-2">
                  <p className="font-bold">Description</p>
                  <textarea
                    className="p-2"
                    placeholder="What did you see? Is there anything you'd like to see?"
                  ></textarea>
                </div>
