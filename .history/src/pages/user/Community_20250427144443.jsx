        ...
        <section className="bg-base-200 px-8 py-6 rounded-lg flex flex-col gap-y-6">
          {posts?.map((post) => (
            <PostCard
              ...
              timestamp={formatTimestamp(post.createdAt)} // Format timestamp
              location={post.barangay} // Directly showing the barangay name here
              ...
              images={post.images}
              coordinates={post.specific_location?.coordinates} // Pass coordinates as a prop
            />
          ))}
        </section>
      </article>
