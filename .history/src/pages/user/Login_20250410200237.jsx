      ...
      >
        ...
        >
          <CustomFormInput
            ...
            type="email"
            value={email}
            onChange={(e) => setEmail(e.target.value)} // Ensure value is controlled
          />
          <CustomFormInput
            label="Password"
            type="password"
            value={password}
            onChange={(e) => setPassword(e.target.value)} // Ensure value is controlled
            isConfirm={true}
          />
          ...
          <div className="flex w-[60%] gap-x-4 mb-[-8px] ">
            <div className="flex-1 border-t-1 border-primary/60 mt-3 text-white  "></div>
