    ...
    <main className="flex justify-center items-center relative h-[100vh]  overflow-hidden">
      ...
      >
        ...
        >
          ...
          <button
            className={`bg-primary  font-extrabold shadow-sm font-bold text-white w-xs py-3 px-4 rounded-2xl hover:cursor-pointer hover:bg-base-200/60 transition-all duration-300 ${
