      ...
      >
        ...
        >
          <div className="w-full text-left relative">
            ...
            <div
              className={`relative rounded-xl px-3 py-2 transition-all duration-200 border border-gray-300 focus-within:outline focus-within:outline-2 focus-within:outline-primary`}
            >
              <select
                value={userType}
                ...
                className="w-full text-xl p-2 outline-none bg-transparent text-black appearance-none"
              >
