...
const Mapping = () => {
  return (
    <div className="flex flex-col pt-8 px-8 items-center bg-primary text-white h-[91.8vh] mt-[-12px] text-center">
      ...
      <CustomDropDown
        ...
        className="mt-4"
      />
      <div className="w-full h-[68vh] mt-4 rounded-md shadow-md ">
