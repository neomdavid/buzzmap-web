...
const Mapping = () => {
  ...
  return (
    <div className="flex flex-col pt-8 px-8 items-center bg-primary text-white h-[91.8vh] mt-[-13px] text-center">
      ...
      <div className="w-full z-[10] h-[68vh] mt-4 rounded-md shadow-md relative">
        <button
        ...
        <select
          ...
          className="absolute top-2 left-1/2 transform -translate-x-1/2 z-[1000] text-black px-3 py-1 rounded shadow"
        >
        ...
        <div className="absolute bottom-2 right-2 z-[1000] text-black bg-white rounded px-3 py-2 text-sm shadow">
