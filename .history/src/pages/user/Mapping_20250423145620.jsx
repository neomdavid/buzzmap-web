...
const Mapping = () => {
  ...
  return (
    <div className="flex flex-col pt-8 px-8 items-center bg-primary text-white h-[130vh] mt-[-13px] text-center">
      ...
      <div className="bg-white text-black rounded-md shadow px-4 py-3 w-full max-w-md mb-4 text-left">
        <p className="font-semibold mb-2 text-xl text-primary">Risk Levels</p>
