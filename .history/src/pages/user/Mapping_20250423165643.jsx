...
const Mapping = () => {
  ...
  const [showBreedingGrounds, setShowBreedingGrounds] = useState(true); // Toggle to show/hide breeding grounds
  ...
  // Add breeding ground marker
  const handleAddBreedingGround = (coords) => {
    setBreedingGrounds((prev) => [...prev, coords]);
  };

  // Filter breeding grounds if the toggle is off
  const breedingGroundMarkers = showBreedingGrounds
  ...
  return (
    <div className="flex flex-col pt-8 px-8 items-center bg-primary text-white h-[95.5vh] mt-[-13px] text-center">
      ...
      <div className="bg-white text-black rounded-md shadow p-6 w-full max-w-md mb-4 text-left">
        <p className="font-semibold mb-2 text-2xl mb-1">Risk Levels</p>
      ...
      <div className="w-full z-[10] h-[68vh] rounded-md shadow-md relative">
        ...
        {/* Toggle breeding ground visibility */}
        <div className="mb-4">
          <label>
            <input
              type="checkbox"
              checked={showBreedingGrounds}
              onChange={() => setShowBreedingGrounds(!showBreedingGrounds)}
            />
        ...
        >
          ...
          {breedingGroundMarkers} {/* Render breeding grounds */}
