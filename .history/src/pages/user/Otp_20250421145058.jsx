  ...
  return (
    <main className="flex h-[100vh] items-center justify-center text-white bg-primary">
      <div className="flex flex-col items-center text-lg">
        ...
        <button
          className={`bg-white text-primary rounded-2xl shadow-[2px_6px_3px_rgba(0,0,0,0.10)] px-4 w-[20%] py-2 text-lg hover:bg-primary/100 transition-all duration-300 cursor-pointer`}
        >
          Verify
        </button>
      </div>
