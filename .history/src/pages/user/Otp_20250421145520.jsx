        ...
        <div className="flex gap-4 mb-6">
          {otp.map((digit, idx) => (
            <input
              ...
              className="w-16 h-16 border border-1-white rounded-md py-10 px-2 text-center text-3xl border-b-2 border-white bg-transparent focus:outline-none focus:border-accent"
            />
          ))}
        </div>
