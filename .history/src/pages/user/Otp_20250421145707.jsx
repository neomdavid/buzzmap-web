        ...
        <div className="flex gap-4 mb-6">
          {otp.map((digit, idx) => (
            <input
              ...
              className="w-16 h-16 border-2  rounded-lg py-10 px-2 text-center text-10xl border-b-2 border-white bg-transparent focus:outline-none focus:border-accent"
            />
          ))}
        </div>
