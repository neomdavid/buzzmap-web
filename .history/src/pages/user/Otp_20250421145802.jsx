  ...
  return (
    <main className="flex h-[100vh] items-center justify-center text-white bg-primary">
      <div className="flex flex-col items-center text-lg gap-6">
        ...
        <div className="flex gap-4 mb-6">
          {otp.map((digit, idx) => (
            <input
              ...
              className="w-40 h-59 border-2  rounded-lg py-10 px-2 text-center text-9xl border-b-2 border-white bg-transparent focus:outline-none focus:border-accent"
            />
          ))}
        </div>
        ...
        <button
          className={`bg-white text-primary rounded-2xl shadow-[2px_6px_3px_rgba(0,0,0,0.10)] px-4 w-[25%] py-2 text-lg hover:bg-base-200 transition-all duration-300 cursor-pointer`}
        >
