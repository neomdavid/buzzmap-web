  ...
  return (
    <main className="flex h-[100vh] items-center justify-center text-white bg-primary">
      <div className="flex flex-col items-center text-xl gap-8">
        ...
        <button
          className={`bg-white text-primary rounded-2xl shadow-[2px_6px_3px_rgba(0,0,0,0.10)] px-4 w-[23%] py-3 text-lg hover:bg-base-200 transition-all duration-300 cursor-pointer`}
        >
