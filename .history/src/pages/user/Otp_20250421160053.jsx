  ...
  return (
    <main className="flex h-[100vh] items-center justify-center text-white bg-primary">
      <div className="flex flex-col items-center text-xl gap-8">
        ...
        <div className="flex gap-5 mb-8">
          {otp.map((digit, idx) => (
            <input
              ...
              className={`w-43 h-65 border-3 border-red-500 rounded-xl py-10 px-2 text-center text-9xl border-b-2 border-white bg-transparent focus:outline-none focus:border-accent ${
        ...
        {isError && (
          <p className="text-red-200 font-semibold text-md mt-[-10px]">
