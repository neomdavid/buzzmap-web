...
const Prevention = () => {
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <div className="relative mt-12 w-[112%] rounded-tl-[450px] rounded-tr-[450px] md:rounded-tl-[1000px] md:rounded-tr-[1000px] md:h-300 z-[-10000] md:w-[120%] md:mb-[-450px] overflow-hidden">
        {/* Image */}
        <img className="w-full h-150 object-cover" src={sprayingAlcohol} />

        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/2 to-transparent z-100000"></div>
      </div>
      <section className="px-12 z-[-1000] py-14 pt-24 w-full bg-primary flex flex-col text-white items-start">
        ...
        <div className="flex justify-center m-auto  w-[93%] mt-24">
          <figure className="border-2 border-red-100 rounded-md w-[80%]"></figure>
