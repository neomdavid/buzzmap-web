  ...
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <div className="relative mt-12 w-[112%] rounded-tl-[450px] rounded-tr-[450px] md:rounded-tl-[1000px] md:rounded-tr-[1000px] md:h-300 md:w-[120%]  overflow-hidden">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/2 to-transparent md:mb-[-450px] md:mt[-450px] z-100000"></div>
      </div>
      <section className="px-12  py-14 pt-24 w-full bg-primary flex flex-col text-white items-start">
