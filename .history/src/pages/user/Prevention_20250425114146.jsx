          ...
          <figure className="hidden sm:flex flex-col bg-white p-8 pt-8 pb-0 border-red-100 rounded-xl w-[80%]">
            ...
            <section className="flex flex-col gap-4 text-white w-full">
              <div className="flex justify-start">
                <div className="flex flex-col sm:w-[80%] lg:w-[50%] lg:mx-[10%] max-w-[400px] bg-primary p-6 rounded-4xl ">
              ...
              <div className="flex justify-end">
                <div className="flex flex-col sm:w-[80%] lg:w-[50%] lg:mx-[10%] bg-primary p-6 rounded-4xl ">
                  <p className="uppercase text-2xl font-semibold mb-3">
                    did you know?
                  </p>
                  <p className="">
