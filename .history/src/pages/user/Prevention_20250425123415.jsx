      ...
      <section className="px-12  py-14 pt-24 w-full bg-primary flex flex-col text-white items-start z-1000000000">
        ...
        <div className="grid grid-cols-2 m-auto md:flex justify-center flex-wrap gap-6 px-4">
          ...
          <AltPreventionCard
            ...
            iconRotation={-15}
            titlePosition="top-18 left-0 lg:top-24.5  xl:top-32"
            subtextPosition="top-53 left-9.5 lg:top-71.5 lg:left-22"
            categoryPosition="top-6 left-[40px] lg:left-25.5 lg:top-13.5 xl:top-19.5 lg:left-27.5"
            bgColor="bg-base-200"
            to="/sanitation"
            titleAlign="center"
            subtextAlign="center"
