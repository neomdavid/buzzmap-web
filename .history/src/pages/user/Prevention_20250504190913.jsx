    ...
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12 px-8 sm:px-23">
        ...
        <div className="grid grid-cols-12 gap-12">
          <div className="col-span-4 gap-3 flex flex-col rounded-xl overflow-hidden">
            <img
          ...
          <div
            className="col-span-8 rounded-xl overflow-hidden flex flex-col justify-end p-4 relative"
            style={{
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at center, transparent 0%, rgba(0,0,0,0.7) 120%)",
              }}
            ></div>

            {/* Content with relative positioning to appear above gradient */}
            <p className="text-left text-white relative z-10">
              MANILA (UPDATE) — The Department of Health (DOH) on Monday said it
              saw a "concerning rise in the number of Dengue cases" in at least
              9 localities in the Philippines...Read More...
            </p>
          </div>
        </div>
      </section>
