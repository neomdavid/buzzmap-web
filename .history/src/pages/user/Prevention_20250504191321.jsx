    ...
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12 px-8 sm:px-23">
        ...
        <div className="grid grid-cols-12 gap-12">
          ...
          <div
            className="col-span-8 rounded-xl overflow-hidden flex flex-col justify-end p-6 relative"
            style={{
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at center, transparent %, rgba(0,0,0,0.7) 100%)",
              }}
            ></div>

            {/* Content with relative positioning to appear above gradient */}
            <p className="mb-2 text-left text-white text-3xl font-semibold relative z-10 max-w-[70%]">
              DOH reports 'concerning rise' of dengue cases in 9 LGUs
            </p>
            <p className="text-left text-white text-lg  relative z-10 max-w-[70%]">
              PHILIPPINE health authorities on Monday flagged a “concerning
              rise” in dengue cases in Luzon, with eight more local
              governments...Read More...{" "}
            </p>
