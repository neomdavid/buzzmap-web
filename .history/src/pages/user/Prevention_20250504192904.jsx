    ...
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12  px-8 md:px-23">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* First article - full width on mobile, 4 cols on md+ */}
          <div className="md:col-span-4 gap-3 flex flex-col rounded-xl overflow-hidden">
            <img
          ...
          {/* Second article (large) and article stack container */}
          <div className="md:col-span-8 flex flex-col md:flex-row gap-6">
            {/* Large featured article */}
            <div className="md:w-2/3 rounded-xl overflow-hidden flex flex-col justify-end p-6 px-8 relative min-h-[400px]">
              <div
              ...
              <div className="relative z-10">
                <p className="text-white mb-3">2 days ago</p>
                ...
                <p className="text-white text-lg">
                  PHILIPPINE health authorities on Monday flagged a "concerning
                  rise"...
                  <button className="text-accent ml-2 font-semibold hover:underline">
                    Read More
                  </button>
                </p>
              </div>
            ...
            {/* Article stack - appears to the right on md+ screens */}
            <div className="md:w-1/3 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 rounded-xl overflow-hidden">
                ...
                <p className="text-left font-semibold text-xl">
                  Philippine Health department flags dengue uptick
                </p>
              ...
              <div className="flex flex-col gap-3 rounded-xl overflow-hidden">
                ...
                <p className="text-left font-semibold">2 days ago</p>
                <p className="text-left font-semibold text-xl">
                  Health officials warn about dengue
                </p>
                <p className="text-left text-base">
                  PHILIPPINE health authorities...
                  <button className="text-primary ml-2 font-semibold hover:underline">
