        ...
        <div className="flex flex-col gap-10 xl:flex-row xl:items-start">
          ...
          <div className="flex gap-10 xl:flex-col xl:flex-[5]">
            ...
            <div className="w-full sm:col-span-6 gap-3 flex flex-col rounded-xl overflow-hidden">
              ...
              <p className="text-left font-semibold text-3xl line-clamp-2 h-[3.5rem] overflow-hidden text-ellipsis">
                Philippine Health department flags worrisome uptick in dengue
                cases in Luzon
              </p>
              {/* Description with line clamp (3 lines max) */}
              <p className="text-left text-lg line-clamp-3 h-[4.5rem] overflow-hidden text-ellipsis">
                PHILIPPINE health authorities on Monday flagged a "concerning
                rise" in dengue cases in Luzon, with eight more local
                governments reporting increased infections. The Department of
                Health has advised residents to take preventive measures.
                <button className="text-primary ml-2 font-semibold hover:underline">
                  Read More
                </button>
              </p>
            </div>
