...
const Prevention = () => {
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <div className="relative mt-12 w-[112%] rounded-tl-[450px] rounded-tr-[450px] md:rounded-tl-[1000px] md:rounded-tr-[1000px] md:h-300 md:mb-[-450px] md:w-[300%] overflow-hidden">
        {/* Image */}
        ...
        <div className="flex  justify-between items-center w-full mb-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-base-300 w-full py-3 px-6 pl-14 rounded-2xl focus:outline-none"
            />
          </div>
        </div>
