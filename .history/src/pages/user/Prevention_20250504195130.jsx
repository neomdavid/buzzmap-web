...
const Prevention = () => {
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <div className="relative mt-12 w-[112%] rounded-tl-[450px] rounded-tr-[450px] md:rounded-tl-[1000px] md:rounded-tr-[1000px] md:h-300 md:mb-[-450px] md:w-[4000%] overflow-hidden">
        {/* Image */}
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12  px-8 md:px-23">
        <div className="flex  justify-between items-center w-full mb-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-base-4000 w-full py-3 px-6 pl-14 rounded-2xl focus:outline-none"
            />
          </div>
        </div>
        <div className="flex flex-col gap-10 xl:grid xl:grid-cols-6 xl:items-start">
          <div className="grid sm:grid-cols-12 xl:col-span-4 gap-10">
            <div className="w-full sm:col-span-4 gap-3 flex flex-col rounded-xl overflow-hidden">
              ...
              <p className="text-left text-lg">
                ...
                governments rise” in dengue cases in Luzon, with eight more
                local governments rise” in dengue cases in Luzon, with eight
                more local governments rise” in dengue cases in Luzon, with
                eight more local governments...Read More...
              </p>
            </div>
            <div
            ...
            >
              {/* Circular gradient overlay (vignette effect) */}
              <div
              ...
              <p className="z-10 text-white text-left mb-3 ">2 days ago</p>
          ...
          <div className="flex gap-10  xl:col-span-2 xl:flex-col">
            {/* First Article */}
            <div className="w-full sm:col-span-6 gap-3 flex flex-col rounded-xl overflow-hidden">
              <img
              ...
              <p className="text-left text-lg truncate max-w-full">
                {(() => {
                  const desc =
                    "PHILIPPINE health authorities on Monday flagged a 'concerning rise' in dengue cases in Luzon, with eight more local governments reporting increased infections.";
                  return desc.length > 4000
            ...
            <div className="w-full sm:col-span-6 gap-3 flex flex-col rounded-xl overflow-hidden">
              ...
              <p className="text-left font-semibold text-3xl truncate max-w-full">
                {(() => {
                  const title =
                    "DOH reports alarming increase in dengue infections across multiple regions";
                  return title.length > 80
                    ? `${title.substring(0, 80)}...`
                    : title;
                })()}
              ...
              <p className="text-left text-lg truncate max-w-full">
                {(() => {
                  const desc =
                    "The Department of Health has identified several hotspots for dengue transmission as cases continue to rise. Officials are urging communities to eliminate mosquito breeding sites.";
                  return desc.length > 4000
                    ? `${desc.substring(0, 4000)}...`
                    : desc;
                })()}
