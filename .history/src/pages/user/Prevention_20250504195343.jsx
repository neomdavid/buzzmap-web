  ...
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12  px-8 md:px-23">
        ...
        <div className="flex flex-col gap-10 xl:grid xl:grid-cols-10 xl:items-start">
          <div className="grid sm:grid-cols-12 xl:col-span-7 gap-10">
          ...
          <div className="flex gap-10  xl:col-span-3 xl:flex-col">
            {/* First Article */}
