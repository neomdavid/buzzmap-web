...
const Prevention = () => {
  return (
    <main className="flex flex-col text-center items-center justify-center mt-2 py-8 overflow-x-hidden">
      ...
      <section className="px-12  py-14 pt-24 w-full bg-primary flex flex-col text-white items-start z-10">
      ...
      <section className="text-primary flex flex-col font-normal w-full p-12  sm:px-23 ">
