      ...
      <div className="w-[80%] mx-auto my-10 rounded-lg overflow-hidden">
        <div className="relative group">
          ...
          <div className={`w-full ${aspectRatioClasses[aspectRatio]} relative`}>
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            >
              ❮
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            >
              ❯
            </button>
          </div>
