...
const SingleArticle = () => {
  ...
  return (
    <main className="mt-[-20px]  flex flex-col text-primary">
      ...
      <p className="text-center p-12 mt-[-30px] tracking-lg">
        It’s that time of year again when the buzzing of mosquitoes becomes a
        familiar soundtrack to our outdoor activities, signaling the presence of
        mosquito breeding places. These pesky insects not only disrupt our
        enjoyment of the great outdoors but also pose serious health risks,
        carrying diseases like Malaria, Chikungunya, and Dengue. But fear not,
        for by understanding where mosquitoes breed and taking proactive
        measures, we can significantly reduce their numbers and safeguard our
        homes and loved ones. Let’s delve into the most common mosquito breeding
        places and explore practical steps to eliminate them. Most Common
        Mosquito Breeding Places Stagnant Puddles Imagine any water that’s been
        sitting still for a while – like in a forgotten bucket or a puddle after
        a rainstorm. Mosquitoes love laying their eggs in these calm waters. So,
        be on the lookout for any spots around your home where water collects
        and stays still. This could be anything from flower pots to clogged
        drains. By getting rid of these stagnant puddles, you’ll make your home
        a lot less inviting to mosquitoes.
      </p>
    </main>
  );
};
