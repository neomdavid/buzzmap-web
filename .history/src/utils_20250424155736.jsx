...
export const toastNeutral = (msg) =>
  toast(msg, {
    position: "top-center",
    icon: "🕊️", // or ℹ️, 🧊, ⬜ for more neutral vibes
    style: {
      background: "#f9fafb", // very light gray (Tailwind gray-50)
      color: "#1f2937", // dark gray text (Tailwind gray-800)
      border: "1px solid #e5e7eb", // soft border (Tailwind gray-200)
      boxShadow: "0 2px 8px rgba(0, 0, 0, 0.05)",
    },
    iconTheme: {
      primary: "#9ca3af", // gray-400
      secondary: "#f3f4f6", // gray-100 (background of icon circle)
    },
  });
