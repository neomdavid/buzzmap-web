      ...
      >
        <div className="modal-box w-11/12 max-w-4xl max-h-[90vh] flex flex-col p-0 cursor-default">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex gap-3">
                      {post?.isAnonymous ? (
                        <UserCircle
                          size={48}
                          className="text-gray-400 mr-[-6px]"
                        />
                      ) : (
                        <img
                          src={
          ...
          <form
            ...
            className="flex items-start gap-3 px-4 py-4 shadow-[0_-1px_4px_2px_rgba(0,0,0,0.08)]"
          >
            <img
              className="h-12 w-12 rounded-full object-cover"
              src={
                  ...
                  <div className="pt-2 gap-3 flex justify-between text-gray-600 bg-gray-200/60 rounded-b-2xl px-4 pb-2 relative shadow-[0_4px_12px_-4px_rgba(0,0,0,0.10)]">
                    <div className="flex gap-3 relative">
                      <div className="relative group">
                        ...
                        <p className="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-600 text-white text-[11px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-display duration-600 ease-in-out whitespace-nowrap pointer-events-none">
                          Add emoji
                        </p>
                      </div>
                      {showEmojiPicker && (
                    ...
                    <div className="relative group cursor-pointer">
                      ...
                      <p className="absolute -top-8.5 -right-7.5 bg-gray-600 text-white text-[11px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-display duration-600 ease-in-out whitespace-nowrap pointer-events-none">
                        Send comment
                      </p>
                    </div>
                  </div>
