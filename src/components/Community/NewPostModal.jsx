...
const NewPostModal = forwardRef(
  ({ onSubmit, initialCoordinates = "", initialBarangay = "" }, ref) => {
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  if (
                                    ...
                                    mapPickerRef.current.panToBarangay
                                  ) {
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          <label className="label">
                            <span className="label-text text-primary font-bold mb-1">
                              City
                            </span>
                          </label>
                          <input
