...
const GoalCard = ({ Icon, title, text, bgColor }) => {
  return (
    <section
      className={`flex flex-col items-center sm:items-start rounded-xl w-full p-5 ${
    ...
    >
      ...
      <p
        ...
        }  text-center text-lg sm:text-left  mb-2`}
      >
        {title}
      </p>
      <p
        className={`${
          bgColor === "light" ? "text-primary" : "text-white"
        }  text-center sm:text-left text-sm font-light`}
      >
        {text}
      </p>
    </section>
