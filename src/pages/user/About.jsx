...
const About = () => {
  return (
    <main className="overflow-clip ">
      <article className="relative bg-primary w-[100vw] md:w-[70vw] max-w-[800px] ml-auto  md:h-[95vh]  md:mt-0 md:pb-4">
        <img
          src={womanWithHand}
        ...
        {/* Logo positioned in lower right corner */}
        <div className="absolute bottom-[-30px] right-[-30px]">
          <img
            src={logoDarkBg}
            className="w-40 h-40 sm:w-45 sm:h-45 md:w-60 md:h-60 opacity-70 rotate-20 rounded-full bg-primary"
            alt="BuzzMap Logo"
          />
        </div>
      </article>
