...
function Profile() {
  ...
  const renderReports = () => {
    const reports =
      profileData?.recentActivity?.reports?.[
          ...
          reports.map((report) => (
            ...
            >
              ...
              <PostCard
                ...
                dateTime={new Date(report.date_and_time).toLocaleString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "long",
                ...
                onVoteUpdate={(newUpvotes, newDownvotes) => {
                  ...
                  setProfileData((prevData) => {
                    ...
                    const updatedReports = {
                      ...prevData.recentActivity.reports,
                    };
                ...
                onPostDeleted={(deletedPostId) => {
                  ...
                  setProfileData((prevData) => {
                    ...
                    // Remove the deleted report from all tabs
                    Object.keys(updatedReports).forEach((tab) => {
                      if (Array.isArray(updatedReports[tab])) {
                        updatedReports[tab] = updatedReports[tab].filter(
                          (r) => r._id !== deletedPostId
                        );
                      }
                    });
    ...
    <main className="text-primary flex flex-col lg:flex-row justify-start lg:justify-center gap-0 lg:gap-20 relative p-6 sm:p-8 pt-20 sm:pt-20 w-full">
      ...
      <section className="hidden lg:flex flex-col lg:w-[30vw] max-w-xl shadow-lg gap-2 p-6 py-14 items-center rounded-t-2xl bg-white rounded-t-[35px] relative z-10 sticky top-24 h-fit max-h-[calc(100vh-6rem)] lg:overflow-y-auto lg:scrollbar-thin lg:scrollbar-thumb-primary sm:scrollbar-track-transparent pr-2">
        ...
        <div className="w-[80%] text-lg flex flex-col gap-6 mb-6">
          ...
          <div className="relative group w-full">
            <div
              className="min-h-[60px] flex items-start w-full p-3 rounded-lg border border-transparent group-hover:border-primary/30 group-hover:bg-gray-50 transition-all duration-200 cursor-pointer"
            ...
            {profileData?.photos?.filter(
              ...
              <div className="col-span-3 text-center py-12">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Share your community reports to see photos here
                </p>
              </div>
            )}
          </div>
      ...
      <dialog ref={editProfileModalRef} className="modal">
        <div className="modal-box w-11/12 max-w-md p-10">
          <p className="font-extrabold text-3xl text-center mb-6">
            Edit Profile
          </p>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  Pending (
                  {profileData?.statistics?.reportsByStatus?.Pending || 0})
                </button>
                <button
                ...
                >
                  Rejected (
                  {profileData?.statistics?.reportsByStatus?.Rejected || 0})
                </button>
              </div>
            </div>
            {renderReports()}
