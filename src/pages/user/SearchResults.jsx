    ...
    if (searchQuery && posts.length > 0) {
      ...
      return {
        ...
        pagination: rawData?.pagination || {
          totalItems: clientFiltered.length,
        },
      };
    }
      ...
      <div className="flex min-h-screen mt-21.5">
        ...
        <aside className="hidden lg:block sticky top-22 bottom-0 w-[300px] bg-base-200/40 text-primary py-10 px-8">
          <p className="text-3xl font-semibold mb-4">
            ...
            <span className="font-extrabold capitalize">"{searchQuery}"</span>
          </p>
          ...
          <div className="flex flex-col font-semibold text-lg gap-1">
            ...
            <div
              ...
              onClick={() =>
                handleFilterChange(
                  "filterType",
                  filters.filterType === "posts" ? "" : "posts"
                )
              }
            >
              <div>
            ...
            <div
              ...
              onClick={() =>
                handleFilterChange(
                  "filterType",
                  filters.filterType === "people" ? "" : "people"
                )
              }
            >
              <div>
            ...
            >
              ...
              <option value="Uncollected Garbage or Trash">
              ...
              <div className="flex flex-col font-semibold text-lg gap-2 bg-base-200/40 p-4 rounded-lg">
                  ...
                  <button
                    className={`flex gap-2 items-center px-4 py-2 rounded-xl whitespace-nowrap ${
                      isAllActive
                        ...
                        : "text-primary hover:bg-primary/60 hover:text-white"
                    }`}
                    onClick={() => {
                      setFilters({
                        barangay: "",
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <option value="Stagnant Water" className="text-primary">
                      Stagnant Water
                    </option>
                    <option
                      value="Uncollected Garbage or Trash"
                      className="text-primary"
                    >
                      Uncollected Garbage or Trash
                    </option>
                    <option value="Others" className="text-primary">
                      Others
                    </option>
                  </select>
                </div>
            ...
            {isLoading && page === 1 ? (
              ...
              <>
                <p className="text-2xl text-primary font-semibold mb-4">
                  Found {data?.pagination?.totalItems || 0} result
                        ...
                        profileImage={
                          post.isAnonymous
                            ...
                            : post.user?.profilePhotoUrl &&
                              post.user.profilePhotoUrl.trim() !== ""
                            ? post.user.profilePhotoUrl
                            : defaultProfile
                        }
                        username={
